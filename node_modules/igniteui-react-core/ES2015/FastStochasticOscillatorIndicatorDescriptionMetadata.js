 ...
 * @hidden
 */
export class FastStochasticOscillatorIndicatorDescriptionMetadata extends Base {
    static b(a) {
    ...
    static d(a) {
        ...
        a.n("FastStochasticOscillatorIndicator", () => new FastStochasticOscillatorIndicatorDescription());
