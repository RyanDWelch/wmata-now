...
var IgrSimpleDefaultTooltip = /** @class */ (function (_super) {
    ...
    IgrSimpleDefaultTooltip.prototype.render = function () {
        return (React.createElement("div", { className: "ui-simple-default-tooltip-content" },
            React.createElement("span", { style: { whiteSpace: "nowrap", fontWeight: "bold" } }, this.getLabel(this.props.context))));
    };
