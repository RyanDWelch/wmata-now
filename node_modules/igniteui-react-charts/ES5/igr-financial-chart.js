...
import { ReactRenderer, ReactWrapper } from "igniteui-react-core/ES5/react-renderer";
import { TypeRegistrar } from "igniteui-react-core/ES5/type";
import { FinancialChart } from './FinancialChart';
import { FinancialChartType_$type } from './FinancialChartType';
import { fromBrushCollection, toBrushCollection, brushToString, stringToBrush, ensureEnum, ensureBool } from "igniteui-react-core/ES5/componentUtil";
...
import { FinancialIndicatorTypeCollection } from './igr-financial-indicator-type-collection';
...
import { FinancialOverlayTypeCollection } from './igr-financial-overlay-type-collection';
...
import { IndicatorDisplayTypeCollection } from './igr-indicator-display-type-collection';
...
import { FinancialChartRangeSelectorOptionCollection } from './igr-financial-chart-range-selector-option-collection';
...
import { FinancialChartCustomIndicatorArgs } from './igr-financial-chart-custom-indicator-args';
import { CustomIndicatorNameCollection as CustomIndicatorNameCollection_internal } from './CustomIndicatorNameCollection';
import { CustomIndicatorNameCollection } from './igr-custom-indicator-name-collection';
import { String_$type } from "igniteui-react-core/ES5/type";
import { IgrTemplateContainer } from "igniteui-react-core/ES5/igr-template-container";
...
var IgrFinancialChart = /** @class */ (function (_super) {
    ...
    Object.defineProperty(IgrFinancialChart.prototype, "volumeType", {
        ...
        */
        ...
        set: function (v) {
            this.i.pr = ensureEnum(FinancialChartVolumeType_$type, v);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(IgrFinancialChart.prototype, "xAxisMode", {
        ...
        */
        ...
        set: function (v) {
            this.i.pt = ensureEnum(FinancialChartXAxisMode_$type, v);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(IgrFinancialChart.prototype, "yAxisMode", {
        ...
        */
        ...
        set: function (v) {
            this.i.pv = ensureEnum(FinancialChartYAxisMode_$type, v);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(IgrFinancialChart.prototype, "isToolbarVisible", {
        ...
        *
        * The `isToolbarVisible` property is used to hide the toolbar.
        *
        * ```ts
        *  <IgrFinancialChart
    ...
    Object.defineProperty(IgrFinancialChart.prototype, "chartType", {
        ...
        */
        ...
        set: function (v) {
            this.i.pm = ensureEnum(FinancialChartType_$type, v);
        },
        enumerable: true,
        configurable: true
    });
        ...
        */
        get: function () {
            if (this._indicatorTypes === null) {
                var coll = new FinancialIndicatorTypeCollection();
                var innerColl = this.i.p0;
                if (!innerColl) {
        ...
        */
        get: function () {
            if (this._overlayTypes === null) {
                var coll = new FinancialOverlayTypeCollection();
    ...
    Object.defineProperty(IgrFinancialChart.prototype, "zoomSliderType", {
        ...
        */
        ...
        set: function (v) {
            this.i.py = ensureEnum(FinancialChartZoomSliderType_$type, v);
        },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(IgrFinancialChart.prototype, "indicatorNegativeBrushes", {
        ...
        */
        get: function () {
            return fromBrushCollection(this.i.ou);
        },
        set: function (v) {
            this.i.ou = toBrushCollection(v);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(IgrFinancialChart.prototype, "indicatorBrushes", {
        ...
        */
        get: function () {
            return fromBrushCollection(this.i.ot);
        },
        set: function (v) {
            this.i.ot = toBrushCollection(v);
        },
        enumerable: true,
        configurable: true
    });
        ...
        */
        get: function () {
            if (this._indicatorDisplayTypes === null) {
                var coll = new IndicatorDisplayTypeCollection();
                var innerColl = this.i.qc;
                if (!innerColl) {
        ...
        */
        get: function () {
            if (this._rangeSelectorOptions === null) {
                var coll = new FinancialChartRangeSelectorOptionCollection();
                var innerColl = this.i.pi;
                if (!innerColl) {
        ...
        */
        get: function () {
            if (this._customIndicatorNames === null) {
                var coll = new CustomIndicatorNameCollection();
    ...
    Object.defineProperty(IgrFinancialChart.prototype, "zoomSliderXAxisMajorStroke", {
        ...
        */
        get: function () {
            return brushToString(this.i.w9);
        },
        set: function (v) {
            this.i.w9 = stringToBrush(v);
        },
        enumerable: true,
        configurable: true
    });
        ...
        */
        ...
        set: function (ev) {
            ...
            this._applyCustomIndicators_wrapped = function (o, e) {
                var outerArgs = new FinancialChartCustomIndicatorArgs();
