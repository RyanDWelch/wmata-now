...
export declare abstract class FinancialIndicator extends FinancialSeries implements ITrendLineSeries {
    ...
    pi: FinancialIndicatorView;
    constructor();
    pu(a: boolean): void;
    protected pm(a: Point, b: Point, c: boolean): boolean;
    ...
    protected ph: AxisRange;
    protected abstract pk(a: number, b: number): boolean;
    protected abstract pn(a: number, b: number): IList$1<string>;
