 ...
 * @hidden
 */
var AnchoredCategorySeriesInteractionManager = /** @class */ (function (_super) {
    tslib_1.__extends(AnchoredCategorySeriesInteractionManager, _super);
    ...
    AnchoredCategorySeriesInteractionManager.prototype.c$b = function (a, b, c, d, e, f, g, h) {
        ...
        if (e == null || e.cc || f == null || d == null || isNaN_(b.x) || isNaN_(b.y)) {
            return h(b);
        }
        if (c <= 1) {
            return h(b);
        }
        var i = truncate(Math.round(a.eb(b)));
        if (i < 0 || i >= a.bz.count) {
            return h(b);
        }
        var j = intDivide(i, c);
        ...
        var m = a.lp(a.bi);
        var n = new ScalerParams(0, a.bs.m4, a.bs.m3, f.b8, a.bs.mu);
        var o = m.top;
        var p = m.bottom;
        var q = o + (p - o) * b.y;
        var r = f.dy(q, n);
    ...
    AnchoredCategorySeriesInteractionManager.prototype.c$a = function (a, b, c, d, e, f) {
        ...
        var j = !g.isEmpty && !h.isEmpty && a.bz != null ? a.bz.indexOf(f) : -1;
        var k = a.lr(a.bi);
        var l = new ScalerParams(0, i, i, c.b8, k);
        var m = new ScalerParams(0, i, i, d.b8, k);
        m.b = a.eh();
        var n = c != null ? c.dv(j, l) : NaN;
        n += e;
        var o = d != null && b != null && j < b.count ? d.dv(b.item(j), m) : NaN;
        if (!isNaN_(n)) {
    ...
    AnchoredCategorySeriesInteractionManager.prototype.c$c = function (a, b) {
        ...
        else if (d != null && d.e6 != null) {
            c += "<span>${item." + d.e6 + "}</span><br/>";
        }
        c += "<span";
        var f = a.a0.a$q(a);
    ...
    AnchoredCategorySeriesInteractionManager.prototype.c$d = function (a, b, c, d, e, f, g, h) {
        ...
        var j = a.bi.bs;
        var k = a.bi.br;
        var l = a.getEffectiveViewport1(a.bi);
        var m = new ScalerParams(0, j, k, d.b8, l);
        m.b = a.eh();
        var n = a.aj(a.ap(), e.f, f, g, b, true);
        if (n == null) {
            return Rect.empty;
        }
        var o = n[0];
