...
import { typeCast, Array_$type, runOn, markType } from "igniteui-react-core/ES5/type";
import { ISortingAxis_$type } from "./ISortingAxis";
import { List$1 } from "igniteui-react-core/ES5/List$1";
import { Path } from "igniteui-react-core/ES5/Path";
import { ScalerParams } from "./ScalerParams";
import { intDivide, isNaN_ } from "igniteui-react-core/ES5/number";
...
var StepLineSeries = /** @class */ (function (_super) {
    ...
    function StepLineSeries() {
        ...
        _this.qg = null;
        _this.qg = new CategoryLineRasterizer();
    ...
    StepLineSeries.prototype.it = function (a) {
    ...
    StepLineSeries.prototype.hv = function (a, b) {
    ...
    StepLineSeries.prototype.qi = function (a, b, c, d, e, f) {
        var g;
        if (b) {
            if (f) {
                g = (a & 1) == 0;
    ...
    StepLineSeries.prototype.on = function (a, b) {
        _super.prototype.on.call(this, a, b);
        var c = b.bs;
        var d = b.br;
        var e = this.getEffectiveViewport1(b);
        var f = typeCast(ISortingAxis_$type, this.px) != null;
        var g = this.px.b8;
        var h = 0;
        if (this.px != null) {
        ...
        if (r) {
            var t = new ScalerParams(0, b.bs, b.br, this.px.b8, e);
 ...
 * @hidden
 */
var StepLineSeriesView = /** @class */ (function (_super) {
