...
import { InteractionState_$type } from "igniteui-react-core/ES5/InteractionState";
import { ModifierKeys_$type } from "igniteui-react-core/ES5/ModifierKeys";
import { HorizontalAlignment_$type } from "igniteui-react-core/ES5/HorizontalAlignment";
import { ChartCursorEventArgs } from "./igr-chart-cursor-event-args";
import { DataChartMouseButtonEventArgs } from "./igr-data-chart-mouse-button-event-args";
import { ChartMouseEventArgs } from "./igr-chart-mouse-event-args";
import { RectChangedEventArgs } from "igniteui-react-core/ES5/igr-rect-changed-event-args";
import { TypeRegistrar } from "igniteui-react-core/ES5/type";
import { NamePatcher, getModifiedProps, isValidProp, fromPoint, toPoint, ensureBool, fromRect, toRect, ensureEnum, brushToString, stringToBrush, toSpinal, initializePropertiesFromCss } from "igniteui-react-core/ES5/componentUtil";
/**
 * Represents a control for viewing series objects.
*/
var IgrSeriesViewer = /** @class */ (function (_super) {
    ...
    Object.defineProperty(IgrSeriesViewer.prototype, "crosshairVisibility", {
        ...
        */
        ...
        set: function (v) {
            this.i.m7 = ensureEnum(Visibility_$type, v);
        },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(IgrSeriesViewer.prototype, "dragModifier", {
        ...
        */
        ...
        set: function (v) {
            this.i.l0 = ensureEnum(ModifierKeys_$type, v);
        },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(IgrSeriesViewer.prototype, "subtitleHorizontalAlignment", {
        ...
        */
        ...
        set: function (v) {
            this.i.ly = ensureEnum(HorizontalAlignment_$type, v);
        },
        enumerable: true,
        configurable: true
    });
        ...
        */
        ...
        set: function (ev) {
            ...
            this._seriesCursorMouseMove_wrapped = function (o, e) {
                var outerArgs = new ChartCursorEventArgs();
        ...
        */
        ...
        set: function (ev) {
            ...
            this._seriesMouseLeftButtonDown_wrapped = function (o, e) {
                var outerArgs = new DataChartMouseButtonEventArgs();
                outerArgs._provideImplementation(e);
        ...
        */
        ...
        set: function (ev) {
            ...
            this._seriesMouseMove_wrapped = function (o, e) {
                var outerArgs = new ChartMouseEventArgs();
                outerArgs._provideImplementation(e);
        ...
        */
        ...
        set: function (ev) {
            ...
            this._windowRectChanged_wrapped = function (o, e) {
                var outerArgs = new RectChangedEventArgs();
                outerArgs._provideImplementation(e);
