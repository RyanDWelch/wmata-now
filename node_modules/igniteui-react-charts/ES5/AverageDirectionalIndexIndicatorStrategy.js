...
import { String_$type, toEnum, markType, getEnumerator } from "igniteui-react-core/ES5/type";
import { List$1 } from "igniteui-react-core/ES5/List$1";
/**
 * @hidden
 */
var AverageDirectionalIndexIndicatorStrategy = /** @class */ (function (_super) {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    _a.label = 2;
                case 2:
                    if (!(e < a.count)) return [3 /*break*/, 7];
                    c = this.j(e, a, b);
                    d = this.i(e, a, b);
                    if (!(c > d && c > 0)) return [3 /*break*/, 4];
                    return [4 /*yield*/, c];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 6];
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    _a.label = 1;
                case 1:
                    if (!(c.moveNext() && d.moveNext())) return [3 /*break*/, 3];
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    _a.label = 2;
                case 2:
                    if (!c.moveNext()) return [3 /*break*/, 4];
