 ...
 */
export var TransitionInSpeedType;
(function (TransitionInSpeedType) {
    /**
 ...
 * @hidden
 */
export var TransitionInSpeedType_$type = markEnum('TransitionInSpeedType', 'Auto,0|Normal,1|ValueScaled,2|IndexScaled,3|Random,4');
