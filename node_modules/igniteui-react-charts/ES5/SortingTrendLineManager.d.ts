 ...
 * @hidden
 */
export declare class SortingTrendLineManager extends CategoryTrendLineManagerBase {
    static $t: Type;
    protected get_g$a(): TrendLineManagerType;
    constructor(a: (arg1: number) => number, b: (arg1: number, arg2: Rect, arg3: Rect) => number);
    p: (arg1: number) => number;
    q: (arg1: number, arg2: Rect, arg3: Rect) => number;
