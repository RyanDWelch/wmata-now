...
import { VerticalAlignment_$type } from "igniteui-react-core/ES5/VerticalAlignment";
...
import { ensureEnum, brushToString, stringToBrush, ensureBool, isValidProp, getModifiedProps, toSpinal, initializePropertiesFromCss, NamePatcher } from "igniteui-react-core/ES5/componentUtil";
...
import { AxisRangeChangedEventArgs } from './igr-axis-range-changed-event-args';
import { AxisAnnotationCollection } from './igr-axis-annotation-collection';
...
* ```
*/
var IgrAxis = /** @class */ (function (_super) {
    ...
    */
    ...
    IgrAxis.prototype.ensureLabelSettings = function () {
        ...
        this.i.aw.angle = this.i.dj();
        this.i.aw.leftMargin = this.i.dl();
        this.i.aw.rightMargin = this.i.dm();
        this.i.aw.topMargin = this.i.dn();
        this.i.aw.bottomMargin = this.i.dk();
        this.i.aw.horizontalAlignment = this.i.ic();
        this.i.aw.verticalAlignment = this.i.i7();
    };
    ...
    IgrAxis.prototype.ensureTitleSettings = function () {
        ...
        this.i.bc.angle = this.i.dp();
        this.i.bc.leftMargin = this.i.dr();
        this.i.bc.rightMargin = this.i.ds();
        this.i.bc.topMargin = this.i.dt();
        this.i.bc.bottomMargin = this.i.dq();
        this.i.bc.horizontalAlignment = this.i.id();
        this.i.bc.verticalAlignment = this.i.i8();
    };
        ...
        */
        get: function () {
            if (this._annotations === null) {
                var coll = new AxisAnnotationCollection();
...
*/
    ...
    */
    IgrAxis.prototype.scaleValue = function (unscaledValue) {
        var iv = this.i.ea(unscaledValue);
        return (iv);
    };
        ...
        */
        ...
        set: function (ev) {
            ...
            this._rangeChanged_wrapped = function (o, e) {
                var outerArgs = new AxisRangeChangedEventArgs();
        ...
        */
        ...
        set: function (ev) {
            ...
            this._renderRequested_wrapped = function (o, e) {
                var outerArgs = new RenderRequestedEventArgs();
                outerArgs._provideImplementation(e);
