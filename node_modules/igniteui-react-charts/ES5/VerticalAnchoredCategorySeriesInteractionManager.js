 ...
 * @hidden
 */
var VerticalAnchoredCategorySeriesInteractionManager = /** @class */ (function (_super) {
    ...
    VerticalAnchoredCategorySeriesInteractionManager.prototype.e$a = function (a, b) {
        var c = a.bs != null ? a.bs.mq : Rect.empty;
        var d = a.bi.br;
        var e = a.lp(a.bi);
        ...
        if (g != null && !c.isEmpty && !d.isEmpty) {
            var i = new ScalerParams(0, c, d, g.b8, f);
            var j = g.dy(e.top, i);
            var k = g.dy(e.bottom, i);
