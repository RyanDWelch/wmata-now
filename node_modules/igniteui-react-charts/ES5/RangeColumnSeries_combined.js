...
import { Type, typeCast, runOn, markType, fromEnum } from "igniteui-react-core/ES5/type";
...
var RangeColumnSeries = /** @class */ (function (_super) {
    tslib_1.__extends(RangeColumnSeries, _super);
    function RangeColumnSeries() {
        var _this = _super.call(this) || this;
        _this.ab = RangeColumnSeries.$;
        return _this;
    }
    RangeColumnSeries.prototype.bf = function () {
        return new RangeColumnSeriesView(this);
    };
    RangeColumnSeries.prototype.it = function (a) {
        _super.prototype.it.call(this, a);
        this.pi = a;
    };
    RangeColumnSeries.prototype.get_nu = function () {
        return true;
    };
    RangeColumnSeries.prototype.preferredCategoryMode = function (a) {
        return 2;
    };
    RangeColumnSeries.prototype.lt = function (a) {
        ...
        var f = new ScalerParams(0, c, d, this.yAxis.b8, e);
        f.b = this.eh();
        var g = this.aj(this.m5(), this.m6.f, this.n6(this.bi), this.n7(this.bi), a, true);
        if (g == null) {
            return Rect.empty;
        }
        var h = g[0];
    ...
    RangeColumnSeries.prototype.dh = function (a, b) {
        if (this.dk(a, b)) {
            return true;
        }
        if (this.l3(a, b)) {
    ...
    RangeColumnSeries.prototype.hv = function (a, b) {
    ...
    RangeColumnSeries.prototype.eg = function () {
        return this.xAxis.jq(this.bi.bs, this.bi.br, this.getEffectiveViewport1(this.bi));
    };
    RangeColumnSeries.prototype.on = function (a, b) {
        ...
        var m = this.xAxis;
        var n = new ScalerParams(0, e, f, this.xAxis.b8, g);
        var o = 0;
 ...
 * @hidden
 */
var RangeColumnSeriesView = /** @class */ (function (_super) {
    tslib_1.__extends(RangeColumnSeriesView, _super);
    ...
    RangeColumnSeriesView.prototype.ap = function () {
    ...
    RangeColumnSeriesView.prototype.c6 = function () {
        var a = new Rectangle();
        this.c0.add(a);
        a._visibility = 1;
        return a;
    };
    RangeColumnSeriesView.prototype.c1 = function (a) {
        a._visibility = 0;
    };
    RangeColumnSeriesView.prototype.c3 = function (a) {
        a._visibility = 1;
    };
    RangeColumnSeriesView.prototype.c2 = function (a) {
        this.c0.remove(a);
    };
    RangeColumnSeriesView.prototype.c4 = function (a, b, c) {
        if (!this.isDirty) {
            this.an();
        }
        a.o = c;
    ...
    RangeColumnSeriesView.prototype.z = function (a) {
        return this.c0._inner[a];
    };
    RangeColumnSeriesView.prototype.y = function (a) {
        var b = this.c0._inner[a];
    ...
    RangeColumnSeriesView.prototype.a3 = function (a, b) {
        _super.prototype.a3.call(this, a, b);
        if (a.d) {
            for (var c = 0; c < this.c0.count; c++) {
                var d = this.x(c, b);
                this.ba(d, c, b);
                a.v(d);
            }
    ...
    RangeColumnSeriesView.prototype.ai = function (a) {
        var e_1, _a, e_2, _b;
        _super.prototype.ai.call(this, a);
        var b = 0;
        var c = new List$1(Rectangle.$, 0);
        try {
            for (var _c = tslib_1.__values(fromEnum(this.cz.a)), _d = _c.next(); !_d.done; _d = _c.next()) {
                var d = _d.value;
                c.add(d);
            }
        }
