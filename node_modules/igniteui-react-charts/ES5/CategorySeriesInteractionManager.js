...
import { Base, typeCast, markType } from "igniteui-react-core/ES5/type";
import { ICategorySeriesInteractionManager_$type } from "./ICategorySeriesInteractionManager";
import { ScalerParams } from "./ScalerParams";
import { ISortingAxis_$type } from "./ISortingAxis";
import { HighlightingInfo } from "./HighlightingInfo";
import { intDivide, truncate, isNaN_ } from "igniteui-react-core/ES5/number";
/**
 * @hidden
 */
var CategorySeriesInteractionManager = /** @class */ (function (_super) {
    ...
    CategorySeriesInteractionManager.prototype.b$c = function (a, b) {
        ...
        if (e != null && !c.isEmpty && !d.isEmpty) {
            var i = new ScalerParams(0, c, d, e.b8, f);
            var j = e.dy(g.left, i);
            var k = e.dy(g.right, i);
    ...
    CategorySeriesInteractionManager.prototype.b$d = function (a, b) {
        ...
        var h = a.lp(a.bi);
        var i = new ScalerParams(0, c, d, f.b8, e);
        var j = f.dy(h.left, i);
        var k = f.dy(h.right, i);
        var l = (b.x - c.left) / c.width;
        var m = j + ((k - j) * l);
        var n = g.i$f(m);
        return n;
