...
export declare abstract class CategorySeries extends MarkerSeries implements IHasCategoryModePreference, ISupportsErrorBars {
    static $t: Type;
    na: CategoryFramePreparer;
    protected bf(): SeriesView;
    ne: CategorySeriesView;
    private nn;
    readonly no: ICategorySeriesInteractionManager;
    ...
    nw: boolean;
    nv: boolean;
    protected nr: boolean;
    protected nq: boolean;
    ...
    protected nz(): boolean;
    protected om(a: AssigningCategoryStyleEventArgs): void;
    protected ol(a: AssigningCategoryMarkerStyleEventArgs): void;
    ...
    private nl;
    private nm;
    protected get_nu(): boolean;
    protected readonly nu: boolean;
    au(a: any, b: Point): HighlightingInfo;
    protected get_cv(): boolean;
    at(a: any, b: Point): HighlightingInfo;
    protected n3(): List$1<Marker>;
    protected nk(a: any, b: Point, c: HighlightingInfo): HighlightingInfo;
    protected nj(a: any, b: Point, c: HighlightingInfo): HighlightingInfo;
    protected ni(a: any, b: Point, c: HighlightingInfo): HighlightingInfo;
    m7: CategoryFrame;
    m9: CategoryFrame;
    m6: CategoryFrame;
    m8: CategoryFrame;
    protected nd: CategorySeriesRenderManager;
    protected oi(a: List$1<number[]>, b: number, c: number, d: CategoryAxisBase, e: ScalerParams, f: boolean): void;
    protected oj(a: List$1<number[]>, b: number, c: number, d: CategoryAxisBase, e: ScalerParams, f: boolean): void;
    dw(a: Rect, b: Rect, c: SeriesView): boolean;
    private n2;
    protected dc(): boolean;
    protected nf(): CategoryTransitionInMode;
    nh: CategoryTransitionSourceFramePreparer;
    protected hw(): void;
    jd(a: boolean): void;
    ...
    oh(a: CategorySeriesView, b: CategoryFrame): void;
    ...
    am(a: Axis): Axis;
    ag(): Axis[];
    static m0(a: List$1<number[]>, b: number, c: Rect, d: Rect, e: boolean): Clipper;
    static $$p: string[];
}
/**
 * @hidden
