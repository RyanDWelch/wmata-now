...
export declare class AnnotationLayerProxy extends Base implements IAnnotationLayerProxy {
    ...
    setHorizontalLineVisibility(a: Series, b: Visibility): void;
    setIsAxisAnnotationEnabled(a: Series, b: boolean): void;
    setLabelMemberPath(a: Series, b: string): void;
    setUseInterpolation(a: Series, b: boolean): void;
    setVerticalLineVisibility(a: Series, b: Visibility): void;
