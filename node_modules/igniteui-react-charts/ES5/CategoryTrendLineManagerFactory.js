...
import { Base, typeCast, markType, TypeRegistrar, NotSupportedException } from "igniteui-react-core/ES5/type";
import { ISortingAxis_$type } from "./ISortingAxis";
import { ScalerParams } from "./ScalerParams";
/**
 * @hidden
 */
var CategoryTrendLineManagerFactory = /** @class */ (function (_super) {
    ...
    CategoryTrendLineManagerFactory.a = function (a, b, c, d, e) {
        if (b != null && typeCast(ISortingAxis_$type, b) !== null) {
            ...
            var f = TypeRegistrar.create("SortingTrendLineManager", (function (g) {
                ...
                var k = new ScalerParams(0, i, h, b.b8, j);
                return b.dy(g, k);
            }));
            f.g$c(c, d);
            return f;
