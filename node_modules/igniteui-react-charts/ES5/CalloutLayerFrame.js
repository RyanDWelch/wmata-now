...
import { Base, Number_$type, markType } from "igniteui-react-core/ES5/type";
import { Brush } from "igniteui-react-core/ES5/Brush";
import { FrameExtended } from "./FrameExtended";
/**
 * @hidden
 */
var CalloutLayerFrame = /** @class */ (function (_super) {
    tslib_1.__extends(CalloutLayerFrame, _super);
    function CalloutLayerFrame() {
        ...
        _this.r = null;
        _this.s = null;
        _this.p = new List$1(Base.$, 0);
        _this.m = new List$1(Base.$, 0);
        _this.q = new List$1(Base.$, 0);
        _this.o = new List$1(Brush.$, 0);
        _this.h = new List$1(Brush.$, 0);
        _this.g = new List$1(Brush.$, 0);
        _this.f = new List$1(Brush.$, 0);
    ...
    CalloutLayerFrame.prototype.c = function (a, b, c) {
        ...
        Frame.b(this.r, a, d.r, e.r);
        Frame.b(this.s, a, d.s, e.s);
        CalloutLayerFrame.v(this.p, a, d.p, e.p);
        CalloutLayerFrame.v(this.m, a, d.m, e.m);
        CalloutLayerFrame.v(this.q, a, d.q, e.q);
    };
    CalloutLayerFrame.v = function (a, b, c, d) {
        var e = c.count;
        var f = d.count;
        var g = Math.max(e, f);
        var h = 1 - b;
    ...
    CalloutLayerFrame.$t = markType(CalloutLayerFrame, 'CalloutLayerFrame', Frame.$);
    return CalloutLayerFrame;
}(Frame));
export { CalloutLayerFrame };
