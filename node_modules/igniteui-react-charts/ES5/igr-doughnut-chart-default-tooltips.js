...
var DoughnutSliceTooltip = function (props) {
    ...
    return (React.createElement("div", { className: 'ui-chart-default-tooltip-content' },
        React.createElement("span", { style: { color: getBrush(props.dataContext.i) } }, getSliceLabel(series, item)),
...
var IgrDoughnutChartDefaultTooltips = /** @class */ (function () {
