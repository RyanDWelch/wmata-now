...
import { Base, INotifyPropertyChanged_$type, BaseError, PropertyChangedEventArgs, Delegate_$type, fromEnum, String_$type, runOn, delegateCombine, EnumUtil, typeCast, delegateRemove, enumGetBox, markType, TypeRegistrar, getInstanceType } from "igniteui-react-core/ES5/type";
...
import { HorizontalAlignment_$type } from "igniteui-react-core/ES5/HorizontalAlignment";
import { UnknownValuePlotting_$type } from "igniteui-react-core/ES5/UnknownValuePlotting";
...
import { DataSeriesAdapter } from "igniteui-react-core/ES5/DataSeriesAdapter";
...
import { IUnknownValuePlotting_$type } from "igniteui-react-core/ES5/IUnknownValuePlotting";
import { ITrendLineSeries_$type } from "./ITrendLineSeries";
import { Random } from "igniteui-react-core/ES5/Random";
import { isNaN_ } from "igniteui-react-core/ES5/number";
import { stringIsNullOrEmpty, stringEmpty } from "igniteui-react-core/ES5/string";
/**
 * @hidden
 */
var DomainChart = /** @class */ (function (_super) {
    ...
    DomainChart.prototype.g2 = function (a, b, c) {
        var _this = this;
        switch (a) {
            case "TitleTopMargin":
                if (this.dataChart != null) {
            ...
            case "PixelScalingRatio":
                if (this.dataChart != null) {
                    this.gw(function (d) { return d.ek = _this.ct; });
                }
                break;
    ...
    DomainChart.prototype.hp = function (a, b, c) {
    };
    ...
    DomainChart.prototype.notifyResized = function () {
        this.gw(function (a) { return a.notifyContainerResized(); });
    };
    ...
    DomainChart.prototype.g8 = function (a) {
    ...
    DomainChart.prototype.gw = function (a) {
        this.gx(a, true);
    };
    DomainChart.prototype.gx = function (a, b) {
        this.gy(a, b, null);
    };
    DomainChart.prototype.gy = function (a, b, c) {
        if (this.dataChart == null) {
            return;
        }
        a(this.dataChart);
    ...
    DomainChart.prototype.hj = function () {
        var e_3, _a, e_4, _b;
        if (this.dataChart == null) {
            return;
        }
    ...
    DomainChart.prototype.hq = function () {
        var a = this.b1("", true);
        if (a != null) {
    ...
    DomainChart.prototype.ho = function (a, b, c) {
    ...
    DomainChart.prototype.hm = function (a) {
        var e_7, _a;
        var _this = this;
        ...
        this.f8(function (b) {
            if (_this.bo(b) && _this.ac.isCalloutLayer(b)) {
                _this.ac.removeCalloutStyleUpdating(b, runOn(_this, _this.g7));
            }
            _this.hf(b);
        });
        try {
    ...
    DomainChart.prototype.gz = function (a, b) {
        if (this.dataChart == null) {
            return;
        }
        ...
        var e = this.g6(runOn(this, this.f5), this.br);
        this.br = e.p1;
    };
    DomainChart.prototype.f5 = function () {
        this.hj();
    };
    DomainChart.prototype.hx = function (a) {
    ...
    DomainChart.prototype.hy = function (a) {
    ...
    DomainChart.prototype.ha = function (a, b) {
    ...
    DomainChart.prototype.g7 = function (a, b) {
        if (this.calloutStyleUpdating != null && a != null) {
            this.calloutStyleUpdating(this, b);
        }
    };
    DomainChart.prototype.g5 = function (a) {
        var _this = this;
        if (!this.b2.contains(a)) {
            this.b2.add(a);
            var b = false;
            var c = this.g6(function () {
                a();
                _this.b2.remove(a);
            }, b);
            b = c.p1;
    ...
    DomainChart.prototype.g6 = function (a, b) {
        if (!b) {
            b = true;
            if (this.di != null) {
    ...
    DomainChart.prototype.ge = function (a) {
        ...
        a.seriesMouseEnter = delegateCombine(a.seriesMouseEnter, function (c, d) { return _this.hb(d.series, d.item); });
        a.seriesMouseLeave = delegateCombine(a.seriesMouseLeave, function (c, d) { return _this.hc(d.series, d.item); });
        a.seriesMouseMove = delegateCombine(a.seriesMouseMove, function (c, d) { return _this.hd(d.series, d.item); });
        a.seriesMouseLeftButtonDown = delegateCombine(a.seriesMouseLeftButtonDown, function (c, d) { return _this.ha(d.series, d.item); });
        a.seriesMouseLeftButtonUp = delegateCombine(a.seriesMouseLeftButtonUp, function (c, d) { return _this.he(d.series, d.item); });
        if (b) {
            a.m4 = this.h6;
        }
        if (b) {
    ...
    DomainChart.prototype.g1 = function (a, b, c) {
        var _this = this;
        if (this.propertyChanged != null) {
            this.propertyChanged(this, new PropertyChangedEventArgs(a));
        }
        switch (a) {
            ...
            case "ExcludedProperties":
                ...
                break;
            case "Brushes":
                this.gy(function (d) { return d.m9 = _this.j; }, true, a);
                break;
            case "Outlines":
                this.gy(function (d) { return d.nc = _this.n; }, true, a);
                break;
            case "Legend":
                this.gw(function (d) { return d.legend = _this.legend; });
                break;
            case "IsHorizontalZoomEnabled":
                this.gw(function (d) { return d.nr = _this.bq; });
                break;
            case "IsVerticalZoomEnabled":
                this.gw(function (d) { return d.nt = _this.bw; });
                break;
            case "WindowRect":
                this.gx(function (d) { return d.m4 = _this.h6; }, false);
                break;
            case "Title":
                this.gx(function (d) { return d.gq = _this.fd; }, false);
                break;
            case "Subtitle":
                this.gx(function (d) { return d.ge = _this.e2; }, false);
                break;
            case "TitleAlignment":
                this.gw(function (d) { return d.lz = _this.hu; });
                break;
            case "SubtitleAlignment":
                this.gw(function (d) { return d.ly = _this.ht; });
                break;
            ...
            case "MarkerTypes":
                ...
                break;
            case "MarkerBrushes":
                this.gw(function (f) { return f.na = _this.l; });
                break;
            case "MarkerOutlines":
                this.gw(function (f) { return f.nb = _this.m; });
                break;
            case "AlignsGridLinesToPixels":
                this.gw(function (f) { return f.nn = _this.bf; });
                break;
            case "AnimateSeriesWhenAxisRangeChanges":
                this.gw(function (f) { return f.cd = _this.bg; });
                break;
            case "ToolTipType":
            ...
            case "CalloutsContentMemberPath":
                var f = this.g6(runOn(this, this.f5), this.br);
                this.br = f.p1;
                break;
        }
        this.g2(a, b, c);
