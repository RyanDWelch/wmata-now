...
import { StyleShapeEventArgs } from "./igr-style-shape-event-args";
import { IgrSeries } from "./igr-series";
/**
 * Series class for rendering polygons.
*/
var IgrShapeSeriesBase = /** @class */ (function (_super) {
    ...
    Object.defineProperty(IgrShapeSeriesBase.prototype, "xAxis", {
        ...
        */
        get: function () {
            ...
            if (!this.i.l5.externalObject) {
                var e = IgrNumericXAxis._createFromInternal(this.i.l5);
                if (e) {
                    e._implementation = this.i.l5;
                }
                this.i.l5.externalObject = e;
            }
            return this.i.l5.externalObject;
        },
        set: function (v) {
            if (v != null && this._stylingContainer && v._styling)
                v._styling(this._stylingContainer, this, this);
            v == null ? this.i.l5 = null : this.i.l5 = v.i;
        },
        enumerable: true,
        configurable: true
    });
        ...
        */
        get: function () {
            ...
            if (!this.i.l7.externalObject) {
                var e = IgrNumericYAxis._createFromInternal(this.i.l7);
                if (e) {
        ...
        */
        ...
        set: function (ev) {
            ...
            this._styleShape_wrapped = function (o, e) {
                var outerArgs = new StyleShapeEventArgs();
