...
import { Base, Point_$type, EnumUtil, markType } from "igniteui-react-core/ES5/type";
 ...
 * @hidden
 */
var DataChartVisualDataManager = /** @class */ (function (_super) {
    ...
    DataChartVisualDataManager.prototype.b = function (a, b) {
        ...
        if (c.ek != null) {
            d = c.s();
            var n = this.a(c, c.ek, d);
            var o = { $type: Point_$type, x: 0, y: f };
            var p = c.e8();
            var q = c.ek.l + p.b + p.e;
