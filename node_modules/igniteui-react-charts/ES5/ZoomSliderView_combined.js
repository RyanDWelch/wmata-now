...
import { Base, runOn, delegateCombine, delegateRemove, markType, INotifyPropertyChanged_$type, PropertyChangedEventArgs, enumGetBox } from "igniteui-react-core/ES5/type";
...
import { CanvasGestureDOMEventProxy } from "igniteui-react-core/ES5/CanvasGestureDOMEventProxy";
import { FontUtil } from "igniteui-react-core/ES5/FontUtil";
import { Size } from "igniteui-react-core/ES5/Size";
import { truncate, isNaN_ } from "igniteui-react-core/ES5/number";
import { ITrackOwner_$type } from "./ITrackOwner";
import { IZoomSlider_$type } from "igniteui-react-core/ES5/IZoomSlider";
 ...
 * @hidden
 */
var ZoomSliderView = /** @class */ (function (_super) {
    ...
    ZoomSliderView.prototype.ai = function () {
        this.az();
    };
    ...
    ZoomSliderView.prototype.at = function () {
        ...
        var c = Math.round(a * this.s);
        var d = Math.round(b * this.s);
    ...
    ZoomSliderView.prototype.av = function (a) {
        if (a.j != null) {
            this.o.z();
        }
        this.o.j(a.j);
    ...
    ZoomSliderView.prototype.ay = function (a, b, c) {
        if (a.j == null) {
    ...
    ZoomSliderView.prototype.ax = function (a, b, c) {
        ...
        if (this.t == null) {
            this.t = function (a) {
                ...
                if (window.devicePixelRatio != undefined && window.devicePixelRatio != c) {
                    _this.j.a4 = window.devicePixelRatio;
                }
            };
    ...
    ZoomSliderView.prototype.ar = function (a) {
        var _this = this;
        if (a == null) {
            this.v = null;
            this.u = null;
        ...
        var h = this.u.createElement("canvas");
        ...
        this.v = h;
        var i = this.u.get2DCanvasContext(this.v);
        ...
        this.a.ai = function (m) { return _this.j.fh.containsPoint(m); };
        this.j.de(0, 0, d, e);
        this.r = FontUtil.getCurrentFontHeight(this.u, this.m);
        this.j.trackDirty();
        this.u.setTimeout(runOn(this, this.ak), 200);
    };
    ZoomSliderView.prototype.af = function (a, b) {
        this.j.c8(a);
    };
    ...
    ZoomSliderView.prototype.aa = function () {
        if (this.a != null) {
            var a = this.a;
    ...
    ZoomSliderView.prototype.ap = function (a) {
    ...
    ZoomSliderView.prototype.a1 = function (a) {
        var b = this.r;
        var c = this.o.f(a.ak);
        return new Size(1, c, b);
    };
    ZoomSliderView.prototype.aq = function () {
        this.s = this.j.a4;
        this.an();
    };
...
var ZoomSlider = /** @class */ (function (_super) {
    ...
    ZoomSlider.prototype.c8 = function (a) {
        if (this.h != 6) {
            this.g.as();
        }
        this.i = this.j(a);
    ...
    ZoomSlider.prototype.ae = function (a) {
        this.i = this.j(a);
        if (this.i == 6) {
            return false;
        }
    ...
    ZoomSlider.prototype.j = function (a) {
    ...
    ZoomSlider.prototype.v = function (a, b, c) {
        if (this.e == 0) {
            var d = b.i * this.fi.width + this.fi.left;
            var e = this.fi.top + this.fi.height / 2;
            var f = new Rect(0, d - c.width / 2, e - c.height / 2, c.width, c.height);
            if (f.containsPoint(a)) {
                return true;
            }
        }
        else {
            var g = b.i * this.fi.height + this.fi.top;
            var h = this.fi.left + this.fi.width / 2;
            var i = new Rect(0, h - c.width / 2, g - c.height / 2, c.width, c.height);
