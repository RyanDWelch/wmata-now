...
import { ensureBool, fromPoint } from "igniteui-react-core/ES5/componentUtil";
/**
...
* ```
*/
var DataChartMouseButtonEventArgs = /** @class */ (function () {
    function DataChartMouseButtonEventArgs() {
    }
    Object.defineProperty(DataChartMouseButtonEventArgs.prototype, "i", {
        /**
         * @hidden
         */
        get: function () {
    ...
    DataChartMouseButtonEventArgs.prototype.onImplementationCreated = function () {
    };
    DataChartMouseButtonEventArgs.prototype._provideImplementation = function (i) {
    ...
    * ```
    */
    DataChartMouseButtonEventArgs.prototype.getPosition = function (relativeTo) {
