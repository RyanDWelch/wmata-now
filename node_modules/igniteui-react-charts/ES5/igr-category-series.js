...
import { AssigningCategoryStyleEventArgs } from "./igr-assigning-category-style-event-args";
import { AssigningCategoryMarkerStyleEventArgs } from "./igr-assigning-category-marker-style-event-args";
import { IgrMarkerSeries } from "./igr-marker-series";
import { ensureBool, ensureEnum, toPoint } from "igniteui-react-core/ES5/componentUtil";
/**
...
* ```
*/
var IgrCategorySeries = /** @class */ (function (_super) {
    ...
    Object.defineProperty(IgrCategorySeries.prototype, "transitionInMode", {
        ...
        */
        ...
        set: function (v) {
            this.i.ng = ensureEnum(CategoryTransitionInMode_$type, v);
        },
        enumerable: true,
        configurable: true
    });
        ...
        */
        ...
        set: function (ev) {
            ...
            this._assigningCategoryStyle_wrapped = function (o, e) {
                var outerArgs = new AssigningCategoryStyleEventArgs();
        ...
        */
        ...
        set: function (ev) {
            ...
            this._assigningCategoryMarkerStyle_wrapped = function (o, e) {
                var outerArgs = new AssigningCategoryMarkerStyleEventArgs();
                outerArgs._provideImplementation(e);
