 ...
 * @hidden
 */
var Stacked100BarBucketCalculator = /** @class */ (function (_super) {
    ...
    Stacked100BarBucketCalculator.prototype.getBucket1 = function (a, b, c, d, e, f) {
        ...
        var v = new ScalerParams(0, d, e, g.xAxis.b8, q);
        h = [f.f._inner[b - this.e][0], g.xAxis.dv(n, v), g.xAxis.dv(m, v)];
        return h;
    };
