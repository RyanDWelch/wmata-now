import { Base, INotifyPropertyChanged, IEnumerable, Type, PropertyChangedEventArgs } from "igniteui-react-core/ES5/type";
...
import { DataSeriesAdapterImplementation } from "igniteui-react-core/ES5/DataSeriesAdapterImplementation";
...
import { DataSeriesMarker } from "igniteui-react-core/ES5/DataSeriesMarker";
...
export declare abstract class DomainChart extends Base implements INotifyPropertyChanged {
    ...
    protected g8(a: string): void;
    protected f8(a: (arg1: Series) => void): void;
    protected f9(a: (arg1: Series, arg2: number) => void): void;
    protected gw(a: (arg1: XamDataChart) => void): void;
    protected gx(a: (arg1: XamDataChart) => void, b: boolean): void;
    protected gy(a: (arg1: XamDataChart) => void, b: boolean, c: string): void;
    ...
    protected abstract hi(a: DataSeries): void;
    protected abstract hh(a: DataSeries): void;
    protected hl(): void;
    private hm;
    protected hn(a: Series): void;
    protected abstract hk(): void;
    private gz;
    protected f5(): void;
    protected hx(a: number): Brush;
    protected h0(a: number): Brush;
    protected hy(a: number): Brush;
    protected hz(a: number): Brush;
    protected h3(a: number): Color;
    ...
    g7(a: any, b: CalloutStyleUpdatingEventArgs): void;
    private b2;
    g5(a: () => void): void;
    private a3;
    g6(a: () => void, b: boolean): {
