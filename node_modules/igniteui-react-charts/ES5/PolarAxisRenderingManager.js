...
import { Base, Point_$type, typeCast, markType } from "igniteui-react-core/ES5/type";
 ...
 * @hidden
 */
var PolarAxisRenderingManager = /** @class */ (function (_super) {
    ...
    PolarAxisRenderingManager.prototype.m = function (a, b, c, d, e, f, g) {
        ...
        h.c = { $type: Point_$type, x: k, y: l };
        h.b = { $type: Point_$type, x: m, y: n };
        a.add(h);
    };
