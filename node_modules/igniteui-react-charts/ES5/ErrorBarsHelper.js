...
import { Base, markType, PointUtil } from "igniteui-react-core/ES5/type";
import { ScalerParams } from "./ScalerParams";
/**
 * @hidden
 */
var ErrorBarsHelper = /** @class */ (function (_super) {
    ...
    ErrorBarsHelper.prototype.k = function (a, b, c, d, e) {
        ...
        var j = new ScalerParams(0, f, g, c.b8, h);
        var k = c.dv(a, j);
        var l = b.getIndependentValue();
        d = Math.abs(Math.round(c.dv(a + l, j) - k));
        e = Math.abs(Math.round(c.dv(a - l, j) - k));
        return {
            p3: d,
            p4: e
        };
    ...
    ErrorBarsHelper.prototype.j = function (a, b, c, d, e) {
        ...
        g = h.p0;
        f = h.p1;
        var i = new ScalerParams(1, f, g, c.b8);
        var j = c.dy(a, i);
        var k = b.getIndependentValue();
        d = Math.abs(Math.round(c.dv(j + k, i) - a));
        e = Math.abs(Math.round(c.dv(j - k, i) - a));
        return {
            p3: d,
            p4: e
        };
    ...
    ErrorBarsHelper.prototype.f = function (a, b, c, d, e, f) {
        ...
        h = i.p0;
        g = i.p1;
        var j = new ScalerParams(1, g, h, c.b8);
        var k = new ScalerParams(1, g, h, d.b8);
        var l = c.dy(a, j);
        var m = b.getDependentValue(l);
        e = Math.abs(Math.round(c.dv(l + m, k) - a));
        f = Math.abs(Math.round(c.dv(l - m, k) - a));
        return {
            p4: e,
            p5: f
        };
    ...
    ErrorBarsHelper.prototype.h = function (a, b, c, d, e) {
        ...
        var i = new ScalerParams(1, f, g, c.b8);
        var j = c.dy(a, i);
        d = Math.abs(Math.round(c.dv(j + b, i) - a));
        e = Math.abs(Math.round(c.dv(j - b, i) - a));
        return {
            p3: d,
            p4: e
        };
    ...
    ErrorBarsHelper.prototype.l = function (a, b, c, d) {
        ...
        if (a.getCalculatorType() == 3) {
            ...
            f = i.p1;
            h = this.a.getEffectiveViewport();
            var j = new ScalerParams(0, f, g, b.b8, h);
            e.x = Math.round(b.dv(d, j));
            e.y = Math.round(c.y);
        }
        else {
            e.x = Math.round(c.x);
