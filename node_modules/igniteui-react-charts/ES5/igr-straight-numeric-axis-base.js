...
*/
var IgrStraightNumericAxisBase = /** @class */ (function (_super) {
    tslib_1.__extends(IgrStraightNumericAxisBase, _super);
    ...
    Object.defineProperty(IgrStraightNumericAxisBase.prototype, "scaleMode", {
        ...
        *     <IgrNumericYAxis name="yAxis" scaleMode="logarithmic" />
        *
        *     <IgrLineSeries
        *      name="series1"
        *     xAxisName="xAxis"
        ...
        */
        ...
        set: function (v) {
            this.i.lb = ensureEnum(NumericScaleMode_$type, v);
        },
        enumerable: true,
        configurable: true
    });
