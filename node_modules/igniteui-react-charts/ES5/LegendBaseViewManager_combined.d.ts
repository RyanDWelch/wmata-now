import { Base, Type, INotifyPropertyChanged, PropertyChangedEventArgs } from "igniteui-react-core/ES5/type";
import { DomWrapper, DomRenderer, NormalizedEvent } from "igniteui-react-core/ES5/dom";
...
import { ILegendContext } from "igniteui-react-core/ES5/ILegendContext";
...
import { ColorData } from "igniteui-react-core/ES5/ColorData";
/**
 * @hidden
 */
export declare class LegendBaseViewManager extends Base {
    ...
    aa(): Size;
    x(a: RenderingContext, b: Polygon, c: GradientData, d: Rect): void;
    r(): void;
    s(): void;
    u(a: boolean): void;
    y(a: string): void;
