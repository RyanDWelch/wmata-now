...
import { ChartSeriesEventArgs } from './igr-chart-series-event-args';
import { brushToString, stringToBrush, toBrushCollection, fromBrushCollection, fromRect, toRect, ensureBool, ensureEnum, isValidProp, getModifiedProps, toSpinal, initializePropertiesFromCss, NamePatcher } from "igniteui-react-core/ES5/componentUtil";
import { MarkerType_$type } from "./MarkerType";
import { delegateCombine, delegateRemove } from "igniteui-react-core/ES5/type";
import { DomainChartSeriesPointerEventArgs } from './igr-domain-chart-series-pointer-event-args';
import { MarkerTypeCollection as MarkerTypeCollection_internal } from './MarkerTypeCollection';
import { MarkerTypeCollection } from './igr-marker-type-collection';
import { SyncableObservableCollection$1 } from "igniteui-react-core/ES5/SyncableObservableCollection$1";
import { ToolTipType_$type } from "igniteui-react-charts/ES5/ToolTipType";
import { CrosshairsDisplayMode_$type } from "igniteui-react-charts/ES5/CrosshairsDisplayMode";
import { CalloutStyleUpdatingEventArgs } from "igniteui-react-charts/ES5/igr-callout-style-updating-event-args";
var IgrDomainChart = /** @class */ (function (_super) {
    ...
    */
    ...
    Object.defineProperty(IgrDomainChart.prototype, "titleAlignment", {
        ...
        */
        ...
        set: function (v) {
            this.i.hu = ensureEnum(HorizontalAlignment_$type, v);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(IgrDomainChart.prototype, "subtitleAlignment", {
        ...
        */
        ...
        set: function (v) {
            this.i.ht = ensureEnum(HorizontalAlignment_$type, v);
        },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(IgrDomainChart.prototype, "resolution", {
        ...
        *
        * Use the `resolution` property for all series in this chart.
        *
        * ```ts
        ...
        */
        get: function () {
            if (this._markerTypes === null) {
                var coll = new MarkerTypeCollection();
        ...
        */
        ...
        set: function (ev) {
            ...
            this._seriesAdded_wrapped = function (o, e) {
                var outerArgs = new ChartSeriesEventArgs();
        ...
        */
        ...
        set: function (ev) {
            ...
            this._seriesPointerEnter_wrapped = function (o, e) {
                var outerArgs = new DomainChartSeriesPointerEventArgs();
                outerArgs._provideImplementation(e);
        ...
        */
        ...
        set: function (ev) {
            ...
            this._calloutStyleUpdating_wrapped = function (o, e) {
                var outerArgs = new CalloutStyleUpdatingEventArgs();
                outerArgs._provideImplementation(e);
