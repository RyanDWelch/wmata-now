...
import { ensureEnum, brushToString, stringToBrush, toPoint, fromPoint } from "igniteui-react-core/ES5/componentUtil";
/**
 * Represents the base class for all IgxDataChartComponent anchored radial category series.
*/
var IgrAnchoredRadialSeries = /** @class */ (function (_super) {
    ...
    Object.defineProperty(IgrAnchoredRadialSeries.prototype, "trendLineType", {
        ...
        */
        ...
        set: function (v) {
            this.i.nt = ensureEnum(TrendLineType_$type, v);
        },
        enumerable: true,
        configurable: true
    });
