...
import { ensureBool, fromPoint, CollectionAdapter, initializePropertiesFromCss, NamePatcher, isValidProp, getModifiedProps, toSpinal } from "igniteui-react-core/ES5/componentUtil";
...
import { HoleDimensionsChangedEventArgs } from "igniteui-react-charts/ES5/igr-hole-dimensions-changed-event-args";
import { RingSeriesBase } from "igniteui-react-charts/ES5/RingSeriesBase";
import { NotifyCollectionChangedAction } from "igniteui-react-core/ES5/NotifyCollectionChangedAction";
import { RingSeriesCollection } from "igniteui-react-charts/ES5/igr-ring-series-collection";
...
import { ContentChildrenManager } from "igniteui-react-core/ES5/ContentChildrenManager";
/**
 * Represents concentric circles divided on arcs  depending on data.
*/
var IgrDoughnutChart = /** @class */ (function (_super) {
        ...
        */
        get: function () {
            ...
            if (this._series === null) {
                var coll = new RingSeriesCollection();
    ...
    */
    ...
    Object.defineProperty(IgrDoughnutChart.prototype, "selectedSliceFill", {
        ...
        */
        get: function () {
            return this.i.ce ? this.i.ce.fill : null;
        },
        set: function (v) {
    ...
    Object.defineProperty(IgrDoughnutChart.prototype, "selectedSliceStroke", {
        ...
        */
        get: function () {
            return this.i.ce ? this.i.ce.stroke : null;
        },
        set: function (v) {
            this.ensureSelectedStyle();
            this.i.ce.stroke = v;
    ...
    Object.defineProperty(IgrDoughnutChart.prototype, "selectedSliceStrokeThickness", {
        ...
        */
        get: function () {
            return this.i.ce ? this.i.ce.strokeThickness : NaN;
        },
        set: function (v) {
            this.ensureSelectedStyle();
            this.i.ce.strokeThickness = +v;
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(IgrDoughnutChart.prototype, "selectedSliceOpacity", {
        ...
        */
        get: function () {
            return this.i.ce ? this.i.ce.opacity : NaN;
        },
        set: function (v) {
            this.ensureSelectedStyle();
            this.i.ce.opacity = +v;
        ...
        */
        ...
        set: function (ev) {
            ...
            this._holeDimensionsChanged_wrapped = function (o, e) {
                var outerArgs = new HoleDimensionsChangedEventArgs();
                outerArgs._provideImplementation(e);
