...
import { IOverviewPlusDetailControl_$type } from "igniteui-react-core/ES5/IOverviewPlusDetailControl";
import { INotifyPropertyChanged_$type, PropertyChangedEventArgs, Type, runOn, delegateCombine, typeCast, delegateRemove, enumGetBox, markType } from "igniteui-react-core/ES5/type";
...
import { ArgumentNullException } from "igniteui-react-core/ES5/ArgumentNullException";
 ...
 * @hidden
 */
var SeriesViewerSurfaceViewer = /** @class */ (function (_super) {
        ...
        switch (a) {
            case SeriesViewerSurfaceViewer.$$p[0]:
                ...
                if (!this.o && !d) {
                    ...
                    var f = RectUtil.l(this.l.mq);
                    var g = new Rect(0, f.x - e / 2, f.y - e / 2, e, e);
                    this.l.m4 = SeriesViewerSurfaceViewer.z(this.l.m4, g, this.l.c3(), this.l.c4(), this.worldRect);
                }
                this.w();
                if (this.l.bi != null) {
...
Type.dep(DependencyProperty, PropertyMetadata, SeriesViewerSurfaceViewer, 'v', ['ZoomLevel::y', [1, 0]]);
