...
var AnchoredCategoryTooltip = function (props) {
    ...
    return (React.createElement("div", { className: 'ui-chart-default-tooltip-content', style: { whiteSpace: "nowrap" } },
        catAxis.isDateTime && React.createElement("span", null, shortDate(catAxis.getItemValue(asAny(props.dataContext.item), "dateTimeMemberPath"))),
        catAxis.isDateTime && React.createElement("br", null),
        (!catAxis.isDateTime && catAxis.label) && React.createElement("span", null, format(asAny(item)[catAxis.label])),
        (!catAxis.isDateTime && catAxis.label) && React.createElement("br", null),
        React.createElement("span", { style: { color: getBrush(s) } },
            s.title,
            ": "),
        React.createElement("span", { className: "ui-tooltip-priority" }, getAnchoredValue(s, item))));
};
var ScatterTooltip = function (props) {
    ...
    if (hasRadius(s)) {
        return (React.createElement("div", { className: 'ui-chart-default-tooltip-content', style: { whiteSpace: "nowrap" } },
            React.createElement("span", { style: { color: getBrush(s) } }, s.title),
            React.createElement("br", null),
            React.createElement("span", { className: "ui-tooltip-priority" },
                "(",
                getXValue(s, item),
                ", ",
                getYValue(s, item),
...
var FinancialTooltip = function (props) {
    ...
    return (React.createElement("div", { className: 'ui-chart-default-tooltip-content', style: { whiteSpace: "nowrap" } },
        catAxis.isDateTime && React.createElement("span", null,
            " ",
            itemLabel,
            " "),
        catAxis.isDateTime && React.createElement("br", null),
        (!catAxis.isDateTime && catAxis.label) && React.createElement("span", null, format(catAxis.getItemValue(asAny(item), "label"))),
        (!catAxis.isDateTime && catAxis.label) && React.createElement("br", null),
        React.createElement("span", { style: { color: getBrush(s) } },
            s.title,
            ": "),
        React.createElement("table", null,
            React.createElement("tbody", null,
                hasOpen(s) ? React.createElement("tr", null,
                    React.createElement("td", null, "Open: "),
                    React.createElement("td", null, getOpenValue(s, item))) : null,
                hasHigh(s) ? React.createElement("tr", null,
                    React.createElement("td", null, "High: "),
                    React.createElement("td", null, getHighValue(s, item))) : null,
                hasLow(s) ? React.createElement("tr", null,
                    React.createElement("td", null, "Low: "),
                    React.createElement("td", null, getLowValue(s, item))) : null,
                hasClose(s) ? React.createElement("tr", null,
                    React.createElement("td", null, "Close: "),
                    React.createElement("td", null, getCloseValue(s, item))) : null,
                hasVolume(s) ? React.createElement("tr", null,
                    React.createElement("td", null, "Volume: "),
                    React.createElement("td", null, getVolumeValue(s, item))) : null))));
};
var PolarTooltip = function (props) {
    ...
    var item = props.dataContext.item;
    return (React.createElement("div", { className: 'ui-chart-default-tooltip-content', style: { whiteSpace: "nowrap" } },
        React.createElement("span", { className: "ui-tooltip-priority" }, getAngleValue(s, item)),
        React.createElement("br", null),
        React.createElement("span", { style: { color: getBrush(s) } },
            s.title,
            ": "),
        React.createElement("span", { className: "ui-tooltip-priority" }, getRadiusValue(s, item))));
};
var RadialTooltip = function (props) {
    ...
    return (React.createElement("div", { className: 'ui-chart-default-tooltip-content', style: { whiteSpace: "nowrap" } },
        axisLabel && React.createElement("span", { className: "ui-tooltip-priority" }, axisLabel),
        axisLabel && React.createElement("br", null),
        React.createElement("span", { style: { color: getBrush(s) } },
            s.title,
            ": "),
        React.createElement("span", { className: "ui-tooltip-priority" }, getAnchoredValue(s, item))));
...
var RangeCategoryTooltip = function (props) {
    ...
    return (React.createElement("div", { className: 'ui-chart-default-tooltip-content', style: { whiteSpace: "nowrap" } },
        ...
        React.createElement("span", { className: "ui-tooltip-priority" },
            getLowValue(s, item),
            " - "),
        React.createElement("span", { className: "ui-tooltip-priority" }, getHighValue(s, item))));
};
var ShapeTooltip = function (props) {
    ...
    return (React.createElement("div", { className: 'ui-chart-default-tooltip-content', style: { whiteSpace: "nowrap" } },
        React.createElement("span", { style: { color: getBrush(s) } }, s.title),
        showXY && React.createElement("br", null),
        showXY && React.createElement("span", null,
            "(",
            getXValue(s, item),
            ", ",
            getYValue(s, item),
            ") "),
        hasColor(s) && React.createElement("br", null),
        hasColor(s) && React.createElement("span", null,
            "value: ",
            getColorValue(s, item)),
        hasValue(s) && React.createElement("br", null),
        hasValue(s) && React.createElement("span", null,
            "value: ",
            item)));
};
var IgrDataChartDefaultTooltips = /** @class */ (function () {
