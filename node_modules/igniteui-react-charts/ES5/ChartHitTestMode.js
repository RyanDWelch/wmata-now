 ...
 */
export var ChartHitTestMode;
(function (ChartHitTestMode) {
    /**
...
})(ChartHitTestMode || (ChartHitTestMode = {}));
/**
 * @hidden
 */
export var ChartHitTestMode_$type = markEnum('ChartHitTestMode', 'Auto,0|Computational,1|ColorEncoded,2|Mixed,3|MixedFavoringComputational,4');
