...
import { brushToString, stringToBrush, toPoint, fromPoint, fromRect, stringToColor, colorToString, ensureEnum, ensureBool, isValidProp, getModifiedProps, toSpinal, initializePropertiesFromCss, NamePatcher } from "igniteui-react-core/ES5/componentUtil";
...
*/
var IgrSeries = /** @class */ (function (_super) {
    tslib_1.__extends(IgrSeries, _super);
...
*/
    ...
    */
    ...
    IgrSeries.prototype.getSeriesValuePositionFromSeriesPixel = function (mouse, useInterpolation, skipUnknowns) {
        var iv = this.i.ll(toPoint(mouse), useInterpolation, skipUnknowns);
        return fromPoint(iv);
    };
    IgrSeries.prototype.getSeriesValueFromSeriesPixel = function (mouse, useInterpolation, skipUnknowns) {
        var iv = this.i.eo(toPoint(mouse), useInterpolation, skipUnknowns);
        return (iv);
    };
    /**
    ...
    */
    IgrSeries.prototype.toWorldPosition = function (seriesPoint) {
        var iv = this.i.ln(toPoint(seriesPoint));
        return fromPoint(iv);
    };
    /**
    ...
    */
    IgrSeries.prototype.fromWorldPosition = function (world) {
        var iv = this.i.lf(toPoint(world));
        return fromPoint(iv);
    };
    /**
