...
import { INotifyPropertyChanged_$type, Base, PropertyChangedEventArgs, Type, typeCast, markType } from "igniteui-react-core/ES5/type";
 ...
 * @hidden
 */
var CalloutAnnotation = /** @class */ (function (_super) {
    tslib_1.__extends(CalloutAnnotation, _super);
    ...
    CalloutAnnotation.prototype.an = function (a, b, c) {
        this.am(a, b, c);
        if (this.propertyChanged != null) {
            this.propertyChanged(this, new PropertyChangedEventArgs(a));
        }
    };
    CalloutAnnotation.prototype.am = function (a, b, c) {
        this.m = true;
    };
