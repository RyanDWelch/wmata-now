...
import { typeCast, markType } from "igniteui-react-core/ES5/type";
import { isNaN_ } from "igniteui-react-core/ES5/number";
/**
 * @hidden
 */
var Stacked100ColumnBucketCalculator = /** @class */ (function (_super) {
    ...
    Stacked100ColumnBucketCalculator.prototype.getBucket1 = function (a, b, c, d, e, f) {
        ...
        var q = 0;
        var r = Math.min(g.ov != null ? g.ov.length : 0, g.ou != null ? g.ou.length : 0);
        var s = c * this.d;
        var t = Math.min(s + this.d - 1, r - 1);
        for (var u = s; u <= t; ++u) {
            k = a.valueColumn.item(u);
            q = Math.abs(g.ov[u]) + g.ou[u];
            if (k < l) {
        ...
        var v = new ScalerParams(0, d, e, i.fragmentYAxis.b8, j);
        h = [f.f._inner[b - this.e][0], i.fragmentYAxis.dv(n, v), i.fragmentYAxis.dv(m, v)];
        return h;
    };
