 ...
 */
export var CalloutCollisionMode;
(function (CalloutCollisionMode) {
    /**
 ...
 * @hidden
 */
export var CalloutCollisionMode_$type = markEnum('CalloutCollisionMode', 'Auto,0|SimulatedAnnealing,1|Greedy,2|GreedyCenterOfMass,3');
