...
import { isValidProp, getModifiedProps, toSpinal, initializePropertiesFromCss, NamePatcher } from "igniteui-react-core/ES2015/componentUtil";
...
{
    padding: 0px;
    padding: var(--legend-item-padding, 0px);
    margin: 5px;
    margin: var(--legend-item-margin, 5px);
}
.ig-chart-legend-item-text
{
...
*/
export class IgrLegendBase extends React.Component {
    constructor(props) {
        super(props);
