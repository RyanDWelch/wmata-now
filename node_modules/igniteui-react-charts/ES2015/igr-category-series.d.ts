...
export declare abstract class IgrCategorySeries<P extends IIgrCategorySeriesProps = IIgrCategorySeriesProps> extends IgrMarkerSeries<P> {
    ...
    */
    assigningCategoryStyle: (s: IgrCategorySeries, e: AssigningCategoryStyleEventArgs) => void;
    ...
    */
    assigningCategoryMarkerStyle: (s: IgrCategorySeries, e: AssigningCategoryMarkerStyleEventArgs) => void;
}
