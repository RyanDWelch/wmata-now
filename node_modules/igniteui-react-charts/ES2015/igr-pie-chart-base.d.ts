...
import { IgDataTemplate } from "igniteui-react-core/ES2015/IgDataTemplate";
...
import { SweepDirection } from "igniteui-react-core/ES2015/SweepDirection";
...
export declare abstract class IgrPieChartBase<P extends IIgrPieChartBaseProps = IIgrPieChartBaseProps> extends React.Component<P, {}> {
    ...
    */
    labelClick: (s: IgrPieChartBase, e: LabelClickEventArgs) => void;
    ...
    */
    selectedItemChanging: (s: IgrPieChartBase, e: SelectedItemChangingEventArgs) => void;
    ...
    */
    selectedItemsChanging: (s: IgrPieChartBase, e: SelectedItemsChangingEventArgs) => void;
    private _selectedItemChanged;
    private _selectedItemChanged_wrapped;
    /**
     * Raised when the SelectedItem property has changed.
    */
    selectedItemChanged: (s: IgrPieChartBase, e: SelectedItemChangedEventArgs) => void;
    private _selectedItemsChanged;
    private _selectedItemsChanged_wrapped;
    /**
     * Raised when the SelectedItems collection has changed.
    */
    selectedItemsChanged: (s: IgrPieChartBase, e: SelectedItemsChangedEventArgs) => void;
    private _sliceClick;
    private _sliceClick_wrapped;
    /**
     * Raised when the slice is clicked.
    */
    sliceClick: (s: IgrPieChartBase, e: SliceClickEventArgs) => void;
}
export interface IIgrPieChartBaseProps {
    ...
    */
     ...
     * Gets or sets the collection of exploded slice indices.
    */
    explodedSlices?: IndexCollection | string;
    /**
     * Gets or sets the pixel amount by which the labels are offset from the edge of the slices.
    */
    ...
    */
     ...
     * select or deselect the slices associated with those items.
    */
    selectedItems?: ObjectCollection | string;
    /**
     * Manually overrides the style to use for the labels.
    */
    textStyle?: string;
