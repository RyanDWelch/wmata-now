...
import { FinancialEventArgs } from "./igr-financial-event-args";
...
export declare abstract class IgrFinancialSeries<P extends IIgrFinancialSeriesProps = IIgrFinancialSeriesProps> extends IgrSeries<P> {
    ...
    * ```
    */
    assigningCategoryStyle: (s: IgrFinancialSeries, e: AssigningCategoryStyleEventArgs) => void;
    private _typical;
    ...
    * ```
    */
    typical: (s: IgrFinancialSeries, e: FinancialEventArgs) => void;
    ...
    * ```
    */
    typicalBasedOn: (s: IgrFinancialSeries, e: FinancialEventArgs) => void;
}
