...
*/
import { Base, Point_$type, Nullable$1, String_$type, fromEnum, markType } from "igniteui-react-core/ES2015/type";
 ...
 * @hidden
 */
export class SeriesInteractionManager extends Base {
    constructor() {
        super(...arguments);
        this.a = null;
        this.b = null;
    ...
    a$j(a, b, c) {
        ...
        let h = new ScalerParams(0, d, e, c.b8, f);
        if (a.bs == null) {
            return -1;
        }
    ...
    a$aj(a, b, c, d, e, f, g, h, i, j) {
        ...
        let l = new ScalerParams(0, a.bi.bs, a.bi.br, f.b8, k);
        if (f.ce) {
            l.b = a.eh();
        }
        ...
        if (!c && g != null) {
            ...
            let q = new ScalerParams(0, m.bs, m.br, g.b8, k);
            q.c = a.bs.m3;
    ...
    h(a, b) {
        let c = a != null && Color.e(Nullable$1.toNullable(Color.$, a.color), Nullable$1.toNullable(Color.$, null));
        c = c && a.color.l > 0;
    ...
    a$q(a) {
        let b = new Color();
        let c = a != null && a.bs != null && a.bs.bn != null && a.bs.bn.i != null ? a.bs.bn.i.af : null;
        c.startCSSQuery();
    ...
    a$ah(a, b) {
        ...
        if (typeof b === 'string') {
            ...
            if (this._toolTipObject != null) {
                ...
                let d = a.k3 != null && Color.e(Nullable$1.toNullable(Color.$, a.k3.color), Nullable$1.toNullable(Color.$, null)) && a.k3.color.l > 0;
                if (d) {
