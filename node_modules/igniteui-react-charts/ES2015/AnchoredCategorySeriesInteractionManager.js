...
*/
import { Base, markType } from "igniteui-react-core/ES2015/type";
 ...
 * @hidden
 */
export class AnchoredCategorySeriesInteractionManager extends Base {
    c$b(a, b, c, d, e, f, g, h) {
        if (!g) {
            return h(b);
        }
        ...
        let m = a.lp(a.bi);
        let n = new ScalerParams(0, a.bs.m4, a.bs.m3, f.b8, a.bs.mu);
        let o = m.top;
        let p = m.bottom;
        let q = o + (p - o) * b.y;
        let r = f.dy(q, n);
    ...
    c$a(a, b, c, d, e, f) {
        ...
        let k = a.lr(a.bi);
        let l = new ScalerParams(0, i, i, c.b8, k);
        let m = new ScalerParams(0, i, i, d.b8, k);
        m.b = a.eh();
        let n = c != null ? c.dv(j, l) : NaN;
        n += e;
        let o = d != null && b != null && j < b.count ? d.dv(b.item(j), m) : NaN;
        if (!isNaN_(n)) {
    ...
    c$d(a, b, c, d, e, f, g, h) {
        ...
        let m = new ScalerParams(0, j, k, d.b8, l);
        m.b = a.eh();
