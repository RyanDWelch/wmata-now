...
import { brushToString, stringToBrush, toPoint, fromPoint, fromRect, stringToColor, colorToString, ensureEnum, ensureBool, isValidProp, getModifiedProps, toSpinal, initializePropertiesFromCss, NamePatcher } from "igniteui-react-core/ES2015/componentUtil";
import { RenderRequestedEventArgs } from './RenderRequestedEventArgs';
import { delegateCombine, delegateRemove, TypeRegistrar } from "igniteui-react-core/ES2015/type";
/**
...
*/
    ...
    */
    ...
    set legendItemVisibility(v) {
        this.i.ly = ensureEnum(Visibility_$type, v);
    }
    /**
    ...
    */
     ...
     * the series object itself.
    *
    * The `legendItemTemplate` is used to describe the visual structure of each legend item in the `IgrLegend`.
    */
    ...
    */
    get shadowColor() {
        return colorToString(this.i.k9);
    }
    set shadowColor(v) {
        this.i.k9 = stringToColor(v);
    }
    /**
    ...
    */
    ...
    set transitionInSpeedType(v) {
        this.i.bp = ensureEnum(TransitionInSpeedType_$type, v);
    }
    /**
    ...
    */
    ...
    set hitTestMode(v) {
        this.i.be = ensureEnum(SeriesHitTestMode_$type, v);
    }
    /**
    ...
    */
    ...
    set actualHitTestMode(v) {
        this.i.bc = ensureEnum(SeriesHitTestMode_$type, v);
    }
    /**
...
*/
    ...
    */
    ...
    getSeriesHighValuePosition(world, useInterpolation, skipUnknowns) {
        let iv = this.i.lg(toPoint(world), useInterpolation, skipUnknowns);
        return fromPoint(iv);
    }
    ...
    getSeriesValuePositionFromSeriesPixel(mouse, useInterpolation, skipUnknowns) {
        let iv = this.i.ll(toPoint(mouse), useInterpolation, skipUnknowns);
        return fromPoint(iv);
    }
    getSeriesValueFromSeriesPixel(mouse, useInterpolation, skipUnknowns) {
        let iv = this.i.eo(toPoint(mouse), useInterpolation, skipUnknowns);
        return (iv);
    }
    /**
    ...
    */
    toWorldPosition(seriesPoint) {
        let iv = this.i.ln(toPoint(seriesPoint));
        return fromPoint(iv);
    }
    /**
    ...
    */
    fromWorldPosition(world) {
        let iv = this.i.lf(toPoint(world));
        return fromPoint(iv);
    }
    /**
    ...
    */
    ...
    set renderRequested(ev) {
        ...
        this._renderRequested_wrapped = (o, e) => {
            let outerArgs = new RenderRequestedEventArgs();
