...
import { ensureEnum, brushToString, stringToBrush, ensureBool, isValidProp, getModifiedProps, toSpinal, initializePropertiesFromCss, NamePatcher } from "igniteui-react-core/ES2015/componentUtil";
    ...
    */
    get crossingAxis() {
        ...
        if (!this.i.ag.externalObject) {
            let e = IgrAxis._createFromInternal(this.i.ag);
            if (e) {
    ...
    */
    get annotations() {
        if (this._annotations === null) {
            let coll = new AxisAnnotationCollection();
...
*/
    ...
    */
    scaleValue(unscaledValue) {
        let iv = this.i.ea(unscaledValue);
        return (iv);
    }
    /**
    ...
    */
    ...
    set rangeChanged(ev) {
        ...
        this._rangeChanged_wrapped = (o, e) => {
            let outerArgs = new AxisRangeChangedEventArgs();
