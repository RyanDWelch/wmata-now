...
*/
import { Base, fromEnum, Number_$type, Point_$type, typeCast, toEnum, markType } from "igniteui-react-core/ES2015/type";
...
export class IndicatorRenderer extends Base {
    ...
    static f(a, b, c, d, e, f, g, h, i) {
        let j = typeCast(GeometryGroup.$, h.aj);
        let k = typeCast(GeometryGroup.$, i.aj);
        let l = c;
        let m = b;
