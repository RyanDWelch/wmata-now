 ...
 * @hidden
 */
export declare class ScatterPolylineSeries extends ShapeSeriesBase {
    static $t: Type;
    constructor();
    protected bf(): SeriesView;
    it(a: SeriesView): void;
    protected m9: ScatterPolylineSeriesView;
    protected get_me(): boolean;
    na: StyleSelector;
    nf: Style;
 ...
 * @hidden
 */
export declare class ScatterPolylineSeriesView extends ShapeSeriesViewBase {
    static $t: Type;
    constructor(a: ScatterPolylineSeries);
