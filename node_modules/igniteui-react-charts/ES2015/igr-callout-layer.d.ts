...
import { CalloutStyleUpdatingEventArgs } from "./igr-callout-style-updating-event-args";
import { CalloutContentUpdatingEventArgs } from "./igr-callout-content-updating-event-args";
import { CalloutLabelUpdatingEventArgs } from "./igr-callout-label-updating-event-args";
import { CalloutSeriesSelectingEventArgs } from "./igr-callout-series-selecting-event-args";
...
export declare class IgrCalloutLayer extends IgrAnnotationLayer<IIgrCalloutLayerProps> {
    ...
    */
    calloutStyleUpdating: (s: IgrCalloutLayer, e: CalloutStyleUpdatingEventArgs) => void;
    ...
    */
    calloutContentUpdating: (s: IgrCalloutLayer, e: CalloutContentUpdatingEventArgs) => void;
    ...
    */
    calloutLabelUpdating: (s: IgrCalloutLayer, e: CalloutLabelUpdatingEventArgs) => void;
    ...
    */
    calloutSeriesSelecting: (s: IgrCalloutLayer, e: CalloutSeriesSelectingEventArgs) => void;
}
