...
*/
import { Base, typeCast, markType } from "igniteui-react-core/ES2015/type";
import { ICategorySeriesInteractionManager_$type } from "./ICategorySeriesInteractionManager";
import { ScalerParams } from "./ScalerParams";
import { ISortingAxis_$type } from "./ISortingAxis";
import { HighlightingInfo } from "./HighlightingInfo";
import { intDivide, truncate, isNaN_ } from "igniteui-react-core/ES2015/number";
/**
 * @hidden
 */
export class CategorySeriesInteractionManager extends Base {
    b$c(a, b) {
        let c = a.bi.bs;
        let d = a.bi.br;
        let e = a.ap();
        ...
        if (e != null && !c.isEmpty && !d.isEmpty) {
            let i = new ScalerParams(0, c, d, e.b8, f);
            let j = e.dy(g.left, i);
            let k = e.dy(g.right, i);
    ...
    b$d(a, b) {
        ...
        let h = a.lp(a.bi);
        let i = new ScalerParams(0, c, d, f.b8, e);
        let j = f.dy(h.left, i);
        let k = f.dy(h.right, i);
        let l = (b.x - c.left) / c.width;
        let m = j + ((k - j) * l);
        let n = g.i$f(m);
        return n;
