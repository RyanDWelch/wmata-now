...
/* scrollbar styles */
.financialChartToolbar select::-webkit-scrollbar
{
	width: 14px;
    width: var(--scrollbar-width, 14px);
	background-color: #eee;
    background-color: var(--financial-toolbar-scrollbar-background-color, #eee);
}
.financialChartToolbar select::-webkit-scrollbar-track
{
	border-radius: 1px;
    border-radius: var(--financial-toolbar-scrollbar-track-radius, 1px);
	background-color: #eee;
    background-color: var(--financial-toolbar-scrollbar-track-background-color, #eee);
	-webkit-box-shadow: inset 0 0 6px rgba(0,0,0,0.3);
}
.financialChartToolbar select::-webkit-scrollbar-thumb
{
	border-radius: 1px;
    border-radius: var(--financial-toolbar-scrollbar-thumb-radius, 1px);
	background-color: #838383;
    background-color: var(--financial-toolbar-scrollbar-thumb-background-color, #838383);
...
.financialChartToolbar .financialChartToolbar {
	...
	max-height: 45px;
	background: #eeeeee;
    background: var(--financial-toolbar-background-color, #eeeeee);
}
...
.financialChartRangeSelectorLabel:hover .financialChartRangeSelectorLabelSpan {
	color: #4897AA;
    color: var(--financial-toolbar-hover-text-color, #4897AA);
}

.financialChartRangeSelectorLabel input:checked + span {
	color: #444444;
    color: var(--financial-toolbar-checked-text-color, #4897AA);
...
.financialChartTypePickerDropDownButton {
    ...
    background-color: var(--financial-toolbar-button-background-color, transparent);
	border:none;
	outline:none;
	cursor:pointer;
	display: flex;
...
.financialChartTypePickerDropDownMenu li.checked {
	color: #4897AA;
    var(--financial-toolbar-checked-text-color, #4897AA);
}
...
/* Icon styles if no theme is includet */
...
const RangeSelectorTemplate = (props) => {
    ...
    return (React.createElement("div", { className: 'financialChartRangeSelector' },
        props.dataContext.vm.oneMonthVisible ? React.createElement("label", { className: 'financialChartRangeSelectorLabel rangeSelectorOneMonth' },
            React.createElement("input", { type: 'radio', value: '1m', checked: props.dataContext.vm.oneMonthChecked, onChange: onChange }),
            React.createElement("span", { className: "financialChartRangeSelectorLabelSpan" }, "1m")) : null,
        props.dataContext.vm.threeMonthsVisible ? React.createElement("label", { className: 'financialChartRangeSelectorLabel rangeSelectorThreeMonths' },
            React.createElement("input", { type: 'radio', value: '3m', checked: props.dataContext.vm.threeMonthsChecked, onChange: onChange }),
            React.createElement("span", { className: "financialChartRangeSelectorLabelSpan" }, "3m")) : null,
        props.dataContext.vm.sixMonthsVisible ? React.createElement("label", { className: 'financialChartRangeSelectorLabel rangeSelectorSixMonths' },
            React.createElement("input", { type: 'radio', value: '6m', checked: props.dataContext.vm.sixMonthsChecked, onChange: onChange }),
            React.createElement("span", { className: "financialChartRangeSelectorLabelSpan" }, "6m")) : null,
        props.dataContext.vm.yearToDateVisible ? React.createElement("label", { className: 'financialChartRangeSelectorLabel rangeSelectorYTD' },
            React.createElement("input", { type: 'radio', value: 'YTD', checked: props.dataContext.vm.yearToDateChecked, onChange: onChange }),
            React.createElement("span", { className: "financialChartRangeSelectorLabelSpan" }, "YTD")) : null,
        props.dataContext.vm.oneYearVisible ? React.createElement("label", { className: 'financialChartRangeSelectorLabel rangeSelectorOneYear' },
            React.createElement("input", { type: 'radio', value: '1y', checked: props.dataContext.vm.oneYearChecked, onChange: onChange }),
            React.createElement("span", { className: "financialChartRangeSelectorLabelSpan" }, "1y")) : null,
        props.dataContext.vm.allVisible ? React.createElement("label", { className: 'financialChartRangeSelectorLabel rangeSelectorAll' },
            React.createElement("input", { type: 'radio', value: 'all', checked: props.dataContext.vm.allChecked, onChange: onChange }),
            React.createElement("span", { className: "financialChartRangeSelectorLabelSpan" }, "all")) : null));
};
const ChartTypePickerTemplate = (props) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("button", { className: 'financialChartTypePickerDropDownButton', onClick: onClick, "data-value": props.dataContext.vm.chartTypeString },
            React.createElement("span", { className: 'ui-icon ui-icon-changeable' }),
            React.createElement("span", { className: 'ui-icon-toolbar-dd' })),
        React.createElement("div", { className: 'financialChartTypePickerDropDownMenu', style: { display: props.dataContext.vm.isOpen ? 'block' : 'none' }, onClick: onDropDownClick },
            React.createElement("ul", null,
                React.createElement("li", { className: 'financialChartListItem', "data-value": 'Auto' },
                    React.createElement("span", { className: 'ui-icon ui-icon-chartAuto' }),
                    React.createElement("span", null, "Auto")),
                React.createElement("li", { className: 'financialChartListItem', "data-value": 'Bar' },
                    React.createElement("span", { className: 'ui-icon ui-icon-BarIcon' }),
                    React.createElement("span", null, "Bar")),
                React.createElement("li", { className: 'financialChartListItem', "data-value": 'Line' },
                    React.createElement("span", { className: 'ui-icon ui-icon-LineIcon' }),
                    React.createElement("span", null, "Line")),
                React.createElement("li", { className: 'financialChartListItem', "data-value": 'Candle' },
                    React.createElement("span", { className: 'ui-icon ui-icon-CandleIcon' }),
                    React.createElement("span", null, "Candle")),
                React.createElement("li", { className: 'financialChartListItem', "data-value": 'Column' },
                    React.createElement("span", { className: 'ui-icon ui-icon-ColumnIcon' }),
...
const IndicatorMenuTemplate = (props) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("button", { className: 'financialChartIndicatorMenuDropDownButton', onClick: onClick },
            React.createElement("div", { className: 'ui-ChartButtonWrapper' },
                React.createElement("span", { className: 'ui-icon ui-icon-IndicatorsIcon' }),
                React.createElement("span", { className: 'financialChartIndicatorMenuLabel' }, "Indicators"),
                React.createElement("span", { className: 'ui-icon-toolbar-dd' }))),
        React.createElement("div", { className: 'financialChartIndicatorMenuDropDownMenu', style: { display: props.dataContext.vm.isOpen ? 'block' : 'none' }, onClick: onDropDownClick },
            React.createElement("ul", { className: 'financialChartIndicatorMenuDropDownMenuList' },
                React.createElement("li", { "data-value": 'FinancialOverlayType' },
                    React.createElement("span", null, "Overlays"),
                    React.createElement("ul", null,
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'BollingerBands' }, "BollingerBands"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'PriceChannel' }, "PriceChannel"))),
                React.createElement("li", { "data-value": 'TrendLineType' },
                    React.createElement("span", null, "Trendlines"),
                    React.createElement("ul", null,
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'LinearFit' }, "LinearFit"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'QuadraticFit' }, "QuadraticFit"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'CubicFit' }, "CubicFit"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'QuarticFit' }, "QuarticFit"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'QuinticFit' }, "QuinticFit"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'LogarithmicFit' }, "LogarithmicFit"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'ExponentialFit' }, "ExponentialFit"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'PowerLawFit' }, "PowerLawFit"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'SimpleAverage' }, "SimpleAverage"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'ExponentialAverage' }, "ExponentialAverage"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'ModifiedAverage' }, "ModifiedAverage"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'CumulativeAverage' }, "CumulativeAverage"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'WeightedAverage' }, "WeightedAverage"))),
                React.createElement("li", { "data-value": 'FinancialChartVolumeType' },
                    React.createElement("span", null, "Volume"),
                    React.createElement("ul", null,
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'Column' }, "Column"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'Line' }, "Line"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'Area' }, "Area"))),
                React.createElement("li", { "data-value": 'FinancialIndicatorType' },
                    React.createElement("span", null, "Standalone Indicators"),
                    React.createElement("ul", null,
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'AbsoluteVolumeOscillator' }, "AbsoluteVolumeOscillator"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'AccumulationDistribution' }, "AccumulationDistribution"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'AverageDirectionalIndex' }, "AverageDirectionalIndex"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'AverageTrueRange' }, "AverageTrueRange"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'BollingerBandWidth' }, "BollingerBandWidth"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'ChaikinOscillator' }, "ChaikinOscillator"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'ChaikinVolatility' }, "ChaikinVolatility"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'CommodityChannelIndex' }, "CommodityChannelIndex"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'DetrendedPriceOscillator' }, "DetrendedPriceOscillator"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'EaseOfMovement' }, "EaseOfMovement"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'FastStochasticOscillator' }, "FastStochasticOscillator"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'ForceIndex' }, "ForceIndex"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'FullStochasticOscillator' }, "FullStochasticOscillator"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'MarketFacilitationIndex' }, "MarketFacilitationIndex"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'MassIndex' }, "MassIndex"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'MedianPrice' }, "MedianPrice"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'MoneyFlowIndex' }, "MoneyFlowIndex"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'MovingAverageConvergenceDivergence' }, "MovingAverageConvergenceDivergence"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'NegativeVolumeIndex' }, "NegativeVolumeIndex"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'OnBalanceVolume' }, "OnBalanceVolume"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'PercentagePriceOscillator' }, "PercentagePriceOscillator"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'PercentageVolumeOscillator' }, "PercentageVolumeOscillator"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'PositiveVolumeIndex' }, "PositiveVolumeIndex"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'PriceVolumeTrend' }, "PriceVolumeTrend"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'RateOfChangeAndMomentum' }, "RateOfChangeAndMomentum"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'RelativeStrengthIndex' }, "RelativeStrengthIndex"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'SlowStochasticOscillator' }, "SlowStochasticOscillator"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'StandardDeviation' }, "StandardDeviation"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'StochRSI' }, "StochRSI"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'TRIX' }, "TRIX"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'TypicalPrice' }, "TypicalPrice"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'UltimateOscillator' }, "UltimateOscillator"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'WeightedClose' }, "WeightedClose"),
                        React.createElement("li", { className: 'financialChartListItem', "data-value": 'WilliamsPercentR' }, "WilliamsPercentR")))))));
};
const ToolbarTemplate = (props) => {
    ...
    return (React.createElement("div", { className: 'financialChartToolbar' },
        React.createElement("div", { className: 'financialChartToolbar' },
            props.dataContext.vm.isIndicatorMenuVisible && React.createElement("div", { className: 'financialChartIndicatorMenu' }, IndicatorMenu ? React.createElement(IndicatorMenu, { dataContext: props.dataContext.vm.financialChartIndicatorMenu }) : React.createElement("div", null)),
            React.createElement("div", { className: 'financialChartRangeSelector' }, RangeSelector ? React.createElement(RangeSelector, { dataContext: props.dataContext.vm.financialChartRangeSelector }) : React.createElement("div", null)),
            React.createElement("div", { className: 'financialChartTypePicker' }, TypePicker ? React.createElement(TypePicker, { dataContext: props.dataContext.vm.financialChartTypePicker }) : React.createElement("div", null)))));
};
