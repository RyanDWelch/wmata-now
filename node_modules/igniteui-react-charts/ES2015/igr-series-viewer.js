...
import { NamePatcher, getModifiedProps, isValidProp, fromPoint, toPoint, ensureBool, fromRect, toRect, ensureEnum, brushToString, stringToBrush, toSpinal, initializePropertiesFromCss } from "igniteui-react-core/ES2015/componentUtil";
/**
    ...
    */
    ...
    set seriesCursorMouseMove(ev) {
        ...
        this._seriesCursorMouseMove_wrapped = (o, e) => {
            let outerArgs = new ChartCursorEventArgs();
    ...
    */
    ...
    set seriesMouseLeftButtonDown(ev) {
        ...
        this._seriesMouseLeftButtonDown_wrapped = (o, e) => {
            let outerArgs = new DataChartMouseButtonEventArgs();
            outerArgs._provideImplementation(e);
    ...
    */
    ...
    set seriesMouseMove(ev) {
        ...
        this._seriesMouseMove_wrapped = (o, e) => {
            let outerArgs = new ChartMouseEventArgs();
            outerArgs._provideImplementation(e);
    ...
    */
    ...
    set windowRectChanged(ev) {
        ...
        this._windowRectChanged_wrapped = (o, e) => {
            let outerArgs = new RectChangedEventArgs();
            outerArgs._provideImplementation(e);
