...
import { Number_$type, fromEnum, Boolean_$type, markType } from "igniteui-react-core/ES2015/type";
...
export class RadialAxisLabelPanel extends HorizontalAxisLabelPanelBase {
    ...
    c8(a, b) {
        ...
        for (let f = 0; f < this.a2.count; f++) {
            let g = this.a2._inner[f];
            if (g.c == c && !g.a) {
...
export class RadialAxisLabelPanelView extends HorizontalAxisLabelPanelBaseView {
    ...
    a2(a) {
        let b = ViewportUtils.f(0.5, this.a.cp, this.a.co);
        this.a.j = ((() => {
            let $ret = new RotateTransform();
