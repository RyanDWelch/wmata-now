...
import { ensureBool, toPoint } from "igniteui-react-core/ES2015/componentUtil";
/**
...
export class IgrRadialBase extends IgrMarkerSeries {
    ...
    */
    get angleAxis() {
        ...
        if (!this.i.mz.externalObject) {
            let e = IgrCategoryAngleAxis._createFromInternal(this.i.mz);
            if (e) {
    ...
    */
    get valueAxis() {
        ...
        if (!this.i.m1.externalObject) {
            let e = IgrNumericRadiusAxis._createFromInternal(this.i.m1);
            if (e) {
    ...
    */
    getAngleFromWorld(world) {
        let iv = this.i.nc(toPoint(world));
        return (iv);
    }
    /**
    ...
    */
    getExactItemIndex(world) {
        let iv = this.i.nd(toPoint(world));
        return (iv);
    }
    /**
