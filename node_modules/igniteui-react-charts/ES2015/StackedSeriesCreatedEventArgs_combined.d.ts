import { EventArgs, Base, Type, Point, INotifyPropertyChanged, PropertyChangedEventArgs } from "igniteui-react-core/ES2015/type";
...
export declare abstract class FragmentBase extends HorizontalAnchoredCategorySeries {
    ...
    m5(): CategoryAxisBase;
    np(): NumericAxisBase;
    qk(a: ISupportsMarkers, b: CategoryFrame, c: number[], d: IDetectsCollisions, e: number, f: number, g: number, h: number): boolean;
    ok(a: CategoryFrame, b: CategorySeriesView): void;
    qm(a: PointCollection, b: List$1<number[]>, c: CategorySeriesView): void;
    dw(a: Rect, b: Rect, c: SeriesView): boolean;
    o6(a: CategorySeriesView): number;
    an(a: Axis): AxisRange;
    ql(): number;
    qn(a: IChartLegend): void;
...
export declare class AreaFragment extends FragmentBase {
    ...
    protected qq(a: Point, b: boolean): boolean;
...
export declare class ColumnFragment extends FragmentBase {
    ...
    dw(a: Rect, b: Rect, c: SeriesView): boolean;
    dt(): boolean;
    n6(a: SeriesView): number;
    n7(a: SeriesView): number;
    lt(a: Point): Rect;
    dh(a: Point, b: boolean): boolean;
    protected dk(a: Point, b: boolean): boolean;
    protected qy(a: Rect, b: number): Rect;
...
export declare abstract class SplineFragmentBase extends SplineSeriesBase {
    ...
    fb(): number;
    a6(): Series;
    qj(a: CategoryFrame, b: number[], c: CollisionAvoider, d: number, e: number, f: CategorySeriesView, g: number): boolean;
    dw(a: Rect, b: Rect, c: SeriesView): boolean;
    an(a: Axis): AxisRange;
    qu(a: CategoryFrame, b: Rect, c: Rect, d: CategoryAxisBase, e: NumericYAxis, f: CategorySeriesView): void;
    ok(a: CategoryFrame, b: CategorySeriesView): void;
    protected iy(a: any, b: string, c: any, d: any): void;
    readonly useHighMarkerFidelity: boolean;
}
...
export declare class SplineAreaFragment extends SplineFragmentBase {
    ...
    ac(): void;
    protected get_ck(): boolean;
    protected qx(a: Point, b: boolean): boolean;
    dh(a: Point, b: boolean): boolean;
    private qw;
    qz: PointCollection;
    hv(a: boolean, b: SeriesView): void;
    on(a: CategoryFrame, b: CategorySeriesView): void;
    je(a: Rect, b: RenderSurface): void;
    qy(a: PointCollection, b: List$1<number[]>, c: CategorySeriesView): void;
    o6(a: CategorySeriesView): number;
    jm(): void;
    readonly useHighMarkerFidelity: boolean;
}
...
export declare abstract class StackedSeriesBase extends CategorySeries implements IIsCategoryBased {
    ...
    ou: number[];
    ov: number[];
    o2: StackedSeriesManager;
    oz: StackedSeriesCollection;
    readonly oy: StackedSeriesCollection;
    private ph;
    private pn;
    private pm;
    jj(a: Point): void;
    nb(a: CategorySeriesView): CategoryFramePreparer;
    ok(a: CategoryFrame, b: CategorySeriesView): void;
    hv(a: boolean, b: SeriesView): void;
    pi(): void;
    po(): void;
    ...
    ox(): CategorySeriesView;
    o8(): number;
    o9(): number;
    pd(a: StackedFragmentSeries): number;
    pc(a: Point): number;
    o6(a: AnchoredCategorySeries, b: Rect, c: Rect, d: SeriesView): boolean;
    private o7;
    pj(): void;
    on(a: CategoryFrame, b: CategorySeriesView): void;
    pl(a: AnchoredCategorySeries, b: CategoryFrame, c: CategorySeriesView): void;
    protected pk(): void;
    protected iy(a: any, b: string, c: any, d: any): void;
