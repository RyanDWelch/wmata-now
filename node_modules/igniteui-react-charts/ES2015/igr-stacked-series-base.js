...
import { isValidProp, getModifiedProps, toPoint, ensureBool, NamePatcher } from "igniteui-react-core/ES2015/componentUtil";
import { StackedSeriesCreatedEventArgs } from './igr-stacked-series-created-event-args';
...
import { CollectionAdapter } from "igniteui-react-core/ES2015/componentUtil";
import { ContentChildrenManager } from "igniteui-react-core/ES2015/ContentChildrenManager";
import { StackedSeriesCollection } from './igr-stacked-series-collection';
/**
    ...
    */
    get series() {
        if (this._series === null) {
            let coll = new StackedSeriesCollection();
    ...
    */
    ...
    set seriesCreated(ev) {
        ...
        this._seriesCreated_wrapped = (o, e) => {
            let outerArgs = new StackedSeriesCreatedEventArgs();
