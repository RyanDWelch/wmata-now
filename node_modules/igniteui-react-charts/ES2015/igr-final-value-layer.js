...
import { ensureEnum, brushToString, stringToBrush } from "igniteui-react-core/ES2015/componentUtil";
/**
...
export class IgrFinalValueLayer extends IgrAnnotationLayer {
    ...
    */
    get targetSeries() {
        ...
        if (!this.i.m6.externalObject) {
            let e = IgrSeries._createFromInternal(this.i.m6);
            if (e) {
    ...
    */
    ...
    set finalValueSelectionMode(v) {
        this.i.m5 = ensureEnum(FinalValueSelectionMode_$type, v);
    }
    /**
