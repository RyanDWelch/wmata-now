    ...
    */
    get xAxis() {
        ...
        if (!this.i.l5.externalObject) {
            let e = IgrNumericXAxis._createFromInternal(this.i.l5);
            if (e) {
    ...
    */
    get yAxis() {
        ...
        if (!this.i.l7.externalObject) {
            let e = IgrNumericYAxis._createFromInternal(this.i.l7);
            if (e) {
    ...
    */
    ...
    set styleShape(ev) {
        ...
        this._styleShape_wrapped = (o, e) => {
            let outerArgs = new StyleShapeEventArgs();
