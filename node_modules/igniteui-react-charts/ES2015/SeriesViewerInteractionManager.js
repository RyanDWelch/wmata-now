...
*/
import { Base, Point_$type, runOn, fromEnum, markType, PointUtil } from "igniteui-react-core/ES2015/type";
 ...
 * @hidden
 */
export class SeriesViewerInteractionManager extends Base {
    constructor() {
        super();
        this.r = 0;
        this.s = 0;
    ...
    f$al(a) {
        ...
        let k = a.bg == 0 && !a.cq && (a.ch || f) && !g && !h;
        let l = a.m3;
        if (k && !isNaN_(b.x) && !l.isEmpty) {
            let m = l.width * (b.x - a.mq.left) / a.mq.width;
            d.ee(l.left + m, l.top, l.left + m, l.bottom);
            d.d3();
            d.d8(m);
        }
        else {
        ...
        if (k && !isNaN_(b.y) && !l.isEmpty) {
            let n = l.height * (b.y - a.mq.top) / a.mq.height;
            d.d7(l.left, l.top + n, l.right, l.top + n);
            d.dz();
        }
        else {
            d.b9();
    ...
    f$p(a, b) {
        if (b.x >= 0 && b.y >= 0 && b.x <= a.m3.width && b.y <= a.m3.height) {
            this.ab(a, b);
        }
        else {
            a.hn();
    ...
    f$aj(a) {
        ...
        b.b8();
        b.ca();
        a.hf({ $type: Point_$type, x: NaN, y: NaN });
        b.b9();
        b.ce();
        b.cd();
        a.bg = 0;
    ...
    f$ag(a, b, c, d, e) {
        ...
        let k = g.width;
        let l = g.height;
        let m = this.af.width / this.o;
        let n = this.af.height / this.p;
        if (m > 1) {
            m = 1;
        }
        if (n > 1) {
    ...
    ac(a) {
        if (this.e == null) {
            this.e = new TileZoomManager(a, true, a.e2);
            this.e.h = !a.db;
        }
        a.cn = true;
        a.ja();
    ...
    f$l(a, b, c) {
        ...
        let f = false;
        let g = new Rect(2, { $type: Point_$type, x: this.ag.x, y: this.ag.y }, b);
        let h = new Rect(0, 0, 0, 0, 0);
        if (!this.ah.isEmpty) {
        ...
        if (this.l(a)) {
            let l = j;
            let m = k.left + k.width * (this.ag.x - b.x) / l.width;
            let n = k.top + k.height * (this.ag.y - b.y) / l.height;
            let o = new Rect(0, m, n, k.width, k.height);
            if (this.m(a, c)) {
                a.i6();
                a.jb(Rect.empty, true);
                a.kl(o, true);
    ...
    f$k(a, b, c) {
        ...
        if (!this.h) {
            let h = false;
            let i = new Rect(2, { $type: Point_$type, x: this.ag.x, y: this.ag.y }, b);
            ...
            if (a.bg == 2) {
                let j = f;
                let k = g.left + g.width * (this.ag.x - b.x) / j.width;
                let l = g.top + g.height * (this.ag.y - b.y) / j.height;
                a.kl(new Rect(0, k, l, g.width, g.height), true);
            }
        }
        let m = false;
        let n = new Rect(2, { $type: Point_$type, x: this.ah.x, y: this.ah.y }, b);
        if (n.width > e || n.height > e) {
            m = true;
        }
        if (m) {
            a.df = true;
    ...
    f$e(a, b, c) {
        let d = a.bn;
        let e = a.mq;
        let f = e.left + e.width * b.x / a.m3.width;
        let g = e.top + e.height * b.y / a.m3.height;
        let h = 1 - MathUtil.b(c, -0.5, 0.5);
        ...
        a.i6();
        this.v(a, 1000);
        a.kl(new Rect(0, i, l, k - i, j - l), true);
        return a.c2();
    }
    v(a, b) {
        a.bn.bw(b);
    ...
    f$c(a, b, c, d, e, f, g) {
        ...
        if (h && c != null) {
            ...
            let p = m;
            if (a.ea != 1) {
                o = truncate(Math.round(d.x * a.ea));
                p = truncate(Math.round(d.y * a.ea));
            }
            let q = c.a(o, p);
        ...
        if (w != null) {
            let ab = w.ar({ $type: Point_$type, x: l, y: m }, g);
            if (ab != null) {
                f = ab;
            }
            return {
    ...
    f$f(a, b) {
        ...
        let c = b.x;
        let d = b.y;
        if (c >= a.m3.left && d >= a.m3.top && c <= a.m3.left + a.m3.width && d <= a.m3.top + a.m3.height) {
            let e = a.bi;
    ...
    f$v(a, b, c, d, e, f) {
        ...
        g.position = d;
        if (a.bg == 2 || a.bg == 1 || a.da || (a.bi != null && a.bi.isPinching)) {
            if (this.d != null) {
                this.d.a0.a$x(this.d, g.position, this.a, g);
                this.d = null;
            }
            return;
        }
        ...
        if (i != null) {
            ...
            if (k) {
                if (l) {
                    if (this.d != null) {
                        j = this.c(this.d);
                        this.d.a0.a$x(this.d, g.position, h, g);
                        if (j != null) {
                            j.a0.a$x(j, g.position, h, g);
                        }
                    }
                }
                this.d = i;
                ...
                this.d = i;
                i.a0.a$z(i, g.position, h, g);
                if (j != null) {
                    j.a0.a$z(j, g.position, h, g);
                }
            }
        }
        else {
            ...
            for (let m = 0; m < a.series.count; m++) {
                ...
                if (n.a0.a$b) {
                    j = this.c(n);
                    n.a0.a$x(n, g.position, n.a0.a$o, g);
                    if (j != null) {
                        j.a0.a$x(j, g.position, n.a0.a$o, g);
                    }
                }
            }
        }
    ...
    f$u(a, b) {
        if (this.d != null) {
            ...
            d.position = b;
            this.d.a0.a$x(this.d, d.position, null, d);
            if (c != null) {
                c.a0.a$x(c, d.position, null, d);
            }
            this.d = null;
        }
        a.im(b);
    ...
    f$t(a, b, c) {
        if (this.d != null) {
            ...
            d.position = c;
            if (b.ag) {
                this.d.a0.a$aa(this.d, d.position, this.a, d);
            }
            else {
                this.d.a0.a$u(this.d, d.position, this.a, d);
            }
        }
    }
    f$w(a, b, c) {
        let d;
        let e = (this.d != null) ? this.d : ((() => { let f = a.bn.e(c, false, d, false); d = f.p2; return f.ret; })());
        if (e != null) {
            let f = new MouseButtonEventArgs();
            f.position = c;
            if (b.ag) {
                e.a0.a$ab(e, f.position, this.a, f);
            }
            else {
                e.a0.a$y(e, f.position, this.a, f);
            }
        }
    }
    f$s(a, b, c) {
