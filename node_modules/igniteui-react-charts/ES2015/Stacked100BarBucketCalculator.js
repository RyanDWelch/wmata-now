...
import { typeCast, markType } from "igniteui-react-core/ES2015/type";
...
export class Stacked100BarBucketCalculator extends StackedBarBucketCalculator {
    ...
    getBucket1(a, b, c, d, e, f) {
        let g = typeCast(StackedBarSeries.$, this.c.cp);
        let h = [NaN, NaN, NaN];
        ...
        let r = Math.min(g.ov != null ? g.ov.length : 0, g.ou != null ? g.ou.length : 0);
        let s = c * this.d;
        ...
        let v = new ScalerParams(0, d, e, g.xAxis.b8, q);
