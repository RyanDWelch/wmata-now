import { EventArgs, IList$1, Base, Type, IEnumerable$1, Point } from "igniteui-react-core/ES2015/type";
...
export declare abstract class FinancialSeries extends Series implements IHasCategoryAxis, IHasCategoryModePreference {
    ...
    private my;
    ob: string;
    mv: IFastItemColumn$1<number>;
    private mu;
    or: string;
    m4: IFastItemColumn$1<number>;
    private m3;
    nd: boolean;
    protected m7: boolean;
    assigningCategoryStyle: (sender: any, args: AssigningCategoryStyleEventArgs) => void;
    protected nf(): boolean;
    protected oz(a: AssigningCategoryStyleEventArgs): void;
    protected mf: CategorySeriesRenderManager;
    protected ox(a: List$1<number[]>, b: number, c: number, d: CategoryAxisBase, e: ScalerParams, f: boolean): void;
    nx(a: Point): number;
    ...
    nz(a: Point, b: boolean, c: boolean): number;
    n0(a: Point, b: boolean, c: boolean): number;
    n1(a: Point, b: boolean, c: boolean): number;
    lg(a: Point, b: boolean, c: boolean): Point;
    li(a: Point, b: boolean, c: boolean): Point;
    pf(a: Point, b: boolean, c: boolean): Point;
    pe(a: Point, b: boolean, c: boolean): Point;
    pg(a: Point, b: boolean, c: boolean): Point;
    ia(): void;
    protected js(a: Rect, b: Rect): void;
    protected jr(a: Rect, b: Rect): void;
    protected ni: Dictionary$2<IFastItemColumn$1<number>, string>;
    protected nj: Dictionary$2<string, string>;
    private m2;
    private ow;
    private m6;
    ...
    m9(a: any): boolean;
    m8(a: any): boolean;
    protected l0(a: number, b: number, c: Axis): any[];
    protected n4(a: SeriesView): number;
    protected n6(a: SeriesView): number;
    lz(a: number, b: number): any[];
    private mq;
    protected get_nb(): boolean;
    protected readonly nb: boolean;
    protected get_cv(): boolean;
    at(a: any, b: Point): HighlightingInfo;
    n8(a: Point): number;
    protected mp(a: any, b: Point, c: HighlightingInfo): HighlightingInfo;
    protected mo(a: any, b: Point, c: HighlightingInfo): HighlightingInfo;
    protected na(): boolean;
    eb(a: Point): number;
    e8(a: Point): number;
    ...
    mc: CategoryFrame;
    l9: CategoryFrame;
    protected ny(a: Rect, b: Rect, c: Rect): number;
    mh: CategoryTransitionInMode;
    ne: boolean;
    protected dc(): boolean;
    protected mg(): CategoryTransitionInMode;
    ...
    mi: CategoryTransitionSourceFramePreparer;
    n2(a: FinancialSeriesView): number;
    protected hw(): void;
    jd(a: boolean): void;
    typical: (sender: any, e: FinancialEventArgs) => void;
    typicalBasedOn: (sender: any, e: FinancialEventArgs) => void;
    protected ng(a: IList$1<string>): boolean;
    readonly nh: boolean;
    protected nc(): boolean;
    protected ov(a: FinancialEventArgs): void;
    protected readonly np: IEnumerable$1<number>;
    private _nm;
    private nm;
    protected readonly no: IEnumerable$1<number>;
    private _nl;
    private nl;
    protected readonly nn: IEnumerable$1<number>;
    private _nk;
    private nk;
    nr(a: IList$1<number>): IList$1<number>;
    private m5;
    protected nq(): IList$1<string>;
    private nv;
    ...
    protected mj(a: number, b: number): FinancialCalculationDataSource;
    n3(a: number): number;
    protected mk(a: FinancialCalculationDataSource): FinancialCalculationSupportingCalculations;
