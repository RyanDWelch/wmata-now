...
*/
import { Base, fromEnum, Number_$type, Point_$type, markType } from "igniteui-react-core/ES2015/type";
...
import { FastFlattener } from "igniteui-react-core/ES2015/FastFlattener";
import { ArrayAccessHelper } from "igniteui-react-core/ES2015/ArrayAccessHelper";
...
export class CategoryLineRasterizer extends Base {
    ...
    m(a, b, c, d, e, f, g, h, i, j) {
        ...
        b.aj = l;
        c.aj = m;
        k.b = new PathFigureCollection();
        l.b = new PathFigureCollection();
        m.b = new PathFigureCollection();
    ...
    j(a, b, c, d, e, f, g, h, i, j, k, l) {
        ...
        d.aj = p;
        m.b = new PathFigureCollection();
        n.b = new PathFigureCollection();
        o.b = new PathFigureCollection();
        p.b = new PathFigureCollection();
        let q = new List$1(PolyLineSegment.$, 0);
