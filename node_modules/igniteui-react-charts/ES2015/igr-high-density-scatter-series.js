...
import { ProgressiveLoadStatusEventArgs } from "./igr-progressive-load-status-event-args";
import { IgrSeries } from "./igr-series";
import { HighDensityScatterSeries } from "./HighDensityScatterSeries";
import { ensureBool, colorToString, stringToColor, toPoint } from "igniteui-react-core/ES2015/componentUtil";
/**
...
export class IgrHighDensityScatterSeries extends IgrSeries {
    ...
    */
    get xAxis() {
        ...
        if (!this.i.l6.externalObject) {
            let e = IgrNumericXAxis._createFromInternal(this.i.l6);
            if (e) {
    ...
    */
    get yAxis() {
        ...
        if (!this.i.l8.externalObject) {
            let e = IgrNumericYAxis._createFromInternal(this.i.l8);
            if (e) {
    ...
    */
    get heatMinimumColor() {
        return colorToString(this.i.oz);
    }
    set heatMinimumColor(v) {
        this.i.oz = stringToColor(v);
    }
    /**
     * Gets or sets the color to use for the maximum end of the scale.
    */
    get heatMaximumColor() {
        return colorToString(this.i.oy);
    }
    set heatMaximumColor(v) {
        this.i.oy = stringToColor(v);
    }
    /**
    ...
    */
    ...
    set progressiveLoadStatusChanged(ev) {
        ...
        this._progressiveLoadStatusChanged_wrapped = (o, e) => {
            let outerArgs = new ProgressiveLoadStatusEventArgs();
