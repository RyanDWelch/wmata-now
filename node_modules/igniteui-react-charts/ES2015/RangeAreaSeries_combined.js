...
import { Array_$type, typeCast, runOn, markType } from "igniteui-react-core/ES2015/type";
...
export class RangeAreaSeries extends HorizontalRangeCategorySeries {
    ...
    on(a, b) {
        ...
        if (k) {
            let m = new ScalerParams(0, b.bs, b.br, this.xAxis.b8, j);
            this.oj(d, -1, this.lowColumn.count, this.xAxis, m, b.n);
        }
        let n = i.c7;
        let o = i.c9;
        let p = i.c3;
        this.nd.ae(n, true, false, true, true);
        this.nd.ae(o, true, false, true, true);
        this.nd.ae(p, false, true, false, false);
        if (b.cr(a)) {
            i.c0(a.f.count, d, false);
            b.cu(a);
        }
        i.c3._opacity = this.nd.i * this.d6;
    }
...
export class RangeAreaSeriesView extends RangeCategorySeriesView {
    ...
    a9() {
        super.a9();
        this.c4.aj = this.c6.aj;
        this.c5.aj = this.c8.aj;
        this.c1.aj = this.c2.aj;
        let a = this.bl();
        this.c4._stroke = a;
