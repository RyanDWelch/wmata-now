...
import { toPoint, fromRect, ensureBool } from "igniteui-react-core/ES2015/componentUtil";
/**
...
*/
    ...
    *     dataSource={this.state.dataSource} >
    *
    *     <IgrCategoryXAxis name="xAxis" gap="0.75" />
    *     <IgrNumericYAxis name="yAxis" />
    *
    *     <IgrColumnSeries
    *      name="series1"
    ...
    *     dataSource={this.state.dataSource} >
    *
    *     <IgrCategoryXAxis name="xAxis" overlap="0.75" />
    *     <IgrNumericYAxis name="yAxis" />
    *
    *     <IgrColumnSeries
    *      name="series1"
    ...
    *     dataSource={this.state.dataSource} >
    *
    *     <IgrCategoryXAxis name="xAxis" useClusteringMode="true" />
    *     <IgrNumericYAxis name="yAxis" />
    *
    *     <IgrColumnSeries
    *      name="series1"
    ...
    */
    ...
    getCategoryBoundingBoxHelper(point, useInterpolation, singularWidth, isVertical) {
        let iv = this.i.ku(toPoint(point), useInterpolation, singularWidth, isVertical);
        return fromRect(iv);
    }
    /**
    ...
    */
    unscaleValue(unscaledValue) {
        let iv = this.i.jv(unscaledValue);
        return (iv);
    }
    notifySetItem(index, oldItem, newItem) {
        this.i.kg(index, oldItem, newItem);
    }
    /**
    ...
    */
    ...
    notifyInsertItem(index, newItem) {
        this.i.ke(index, newItem);
    }
    notifyRemoveItem(index, oldItem) {
        this.i.kf(index, oldItem);
    }
}
