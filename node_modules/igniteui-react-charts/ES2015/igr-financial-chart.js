...
import { fromBrushCollection, toBrushCollection, brushToString, stringToBrush, ensureEnum, ensureBool } from "igniteui-react-core/ES2015/componentUtil";
import { IgrXYChart } from './igr-xy-chart';
import { DataChartStylingDefaults } from './DataChartStylingDefaults';
import { DataSeriesType } from "igniteui-react-core/ES2015/DataSeriesType";
...
import { String_$type } from "igniteui-react-core/ES2015/type";
import { IgrTemplateContainer } from "igniteui-react-core/ES2015/igr-template-container";
    ...
    */
    get indicatorTypes() {
        if (this._indicatorTypes === null) {
            let coll = new FinancialIndicatorTypeCollection();
            let innerColl = this.i.p0;
            if (!innerColl) {
    ...
    */
    get overlayTypes() {
        if (this._overlayTypes === null) {
            let coll = new FinancialOverlayTypeCollection();
            let innerColl = this.i.p2;
            if (!innerColl) {
    ...
    */
    get indicatorDisplayTypes() {
        if (this._indicatorDisplayTypes === null) {
            let coll = new IndicatorDisplayTypeCollection();
            let innerColl = this.i.qc;
            if (!innerColl) {
    ...
    */
    get rangeSelectorOptions() {
        if (this._rangeSelectorOptions === null) {
            let coll = new FinancialChartRangeSelectorOptionCollection();
            let innerColl = this.i.pi;
            if (!innerColl) {
    ...
    */
    get customIndicatorNames() {
        if (this._customIndicatorNames === null) {
            let coll = new CustomIndicatorNameCollection();
    ...
    */
    ...
    set applyCustomIndicators(ev) {
        ...
        this._applyCustomIndicators_wrapped = (o, e) => {
            let outerArgs = new FinancialChartCustomIndicatorArgs();
