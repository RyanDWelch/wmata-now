...
*/
import { Base, typeCast, Number_$type, markType } from "igniteui-react-core/ES2015/type";
import { Brush } from "igniteui-react-core/ES2015/Brush";
import { Color } from "igniteui-react-core/ES2015/Color";
import { LinearGradientBrush } from "igniteui-react-core/ES2015/LinearGradientBrush";
...
import { truncate, log10 } from "igniteui-react-core/ES2015/number";
...
export class AxisAnnotationFrameManager extends Base {
    ...
    static c(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r) {
        ...
        if (t != null) {
            let y = new ScalerParams(1, d.mq, t.i0, t.b8);
            y.c = e;
            let z = t.dy(b.x, y);
            a.p.add(z);
            a.o.add(z);
        ...
        if (u != null) {
            let aa = new ScalerParams(1, d.mq, u.i0, u.b8);
            aa.c = e;
            let ab = u.dy(b.y, aa);
            a.aa.add(ab);
            a.z.add(ab);
        ...
        for (let n = 0; n < b.p.count; n++) {
            ...
            if (o != null) {
                ...
                if (!d.containsKey(o)) {
                    ...
                    p.activate = (q) => o.al.add(q);
                    p.disactivate = (q) => o.al.remove(q);
                    d.item(o, p);
                    e.add(o);
                }
                else {
        ...
        for (let t = 0; t < b.aa.count; t++) {
            ...
            if (u != null) {
                ...
                if (!d.containsKey(u)) {
                    ...
                    v.activate = (w) => u.al.add(w);
                    v.disactivate = (w) => u.al.remove(w);
                    d.item(u, v);
                    e.add(u);
                }
                else {
