...
import { IgRect } from "igniteui-react-core/ES2015/IgRect";
import { IgPoint } from "igniteui-react-core/ES2015/IgPoint";
...
import { InteractionState } from "igniteui-react-core/ES2015/InteractionState";
import { ModifierKeys } from "igniteui-react-core/ES2015/ModifierKeys";
...
import { RectChangedEventArgs } from "igniteui-react-core/ES2015/igr-rect-changed-event-args";
...
export declare abstract class IgrSeriesViewer<P extends IIgrSeriesViewerProps = IIgrSeriesViewerProps> extends React.Component<P, {}> {
    ...
    */
    readonly contentViewport: IgRect;
    /**
    ...
    */
    seriesCursorMouseMove: (s: IgrSeriesViewer, e: ChartCursorEventArgs) => void;
    ...
    * ```
    */
    seriesMouseLeftButtonDown: (s: IgrSeriesViewer, e: DataChartMouseButtonEventArgs) => void;
    ...
    * ```
    */
    seriesMouseLeftButtonUp: (s: IgrSeriesViewer, e: DataChartMouseButtonEventArgs) => void;
    ...
    * ```
    */
    seriesMouseMove: (s: IgrSeriesViewer, e: ChartMouseEventArgs) => void;
    ...
    * ```
    */
    seriesMouseEnter: (s: IgrSeriesViewer, e: ChartMouseEventArgs) => void;
    ...
    * ```
    */
    seriesMouseLeave: (s: IgrSeriesViewer, e: ChartMouseEventArgs) => void;
    ...
    * &lt;-- position: content member-->
    */
    windowRectChanged: (s: IgrSeriesViewer, e: RectChangedEventArgs) => void;
    ...
    * ```
    */
    sizeChanged: (s: IgrSeriesViewer, e: RectChangedEventArgs) => void;
    ...
    */
    actualWindowRectChanged: (s: IgrSeriesViewer, e: RectChangedEventArgs) => void;
    ...
    */
    gridAreaRectChanged: (s: IgrSeriesViewer, e: RectChangedEventArgs) => void;
}
