...
*/
import { Base, INotifyPropertyChanged_$type, PropertyChangedEventArgs, markType, enumGetBox } from "igniteui-react-core/ES2015/type";
import { ThumbRangePosition_$type } from "./ThumbRangePosition";
/**
 * @hidden
 */
export class TrackThumbRange extends Base {
    constructor() {
        super(...arguments);
        this.i = 0;
        this.j = 0;
 ...
 * @hidden
 */
export class TrackThumb extends Base {
    constructor() {
        super(...arguments);
        this.g = 0;
        this.h = 0;
