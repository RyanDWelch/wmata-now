...
import { TriangulationStatusEventArgs } from "igniteui-react-core/ES2015/igr-triangulation-status-event-args";
...
export class IgrScatterTriangulationSeries extends IgrSeries {
    ...
    */
    get xAxis() {
        ...
        if (!this.i.lz.externalObject) {
            let e = IgrNumericXAxis._createFromInternal(this.i.lz);
            if (e) {
                e._implementation = this.i.lz;
            }
            this.i.lz.externalObject = e;
        }
        return this.i.lz.externalObject;
    }
    set xAxis(v) {
        if (v != null && this._stylingContainer && v._styling)
            v._styling(this._stylingContainer, this, this);
        v == null ? this.i.lz = null : this.i.lz = v.i;
    }
    /**
    ...
    */
    get yAxis() {
        ...
        if (!this.i.l0.externalObject) {
            let e = IgrNumericYAxis._createFromInternal(this.i.l0);
            if (e) {
    ...
    */
    ...
    set triangulationStatusChanged(ev) {
        ...
        this._triangulationStatusChanged_wrapped = (o, e) => {
            let outerArgs = new TriangulationStatusEventArgs();
